	...
	[9277],
	{
		'./node_modules/@storybook/blocks/dist/Color-PRSJMWNM.mjs': (
			...
			var R,
				...
				Input = (0, dist.zo)(components_dist.l0.Input)(
					({ theme, readOnly }) => ({
						width: '100%',
						paddingLeft: 30,
						paddingRight: 30,
				...
				ToggleIcon = (0, dist.zo)(icons_dist.leI)(({ theme }) => ({
					position: 'absolute',
					zIndex: 1,
					top: 6,
					right: 7,
				...
				parseValue = (value) => {
					...
					if (RGB_REGEXP.test(value)) {
						let [r, g, b, a] = stringToArgs(value),
							[h, s, l] = color_convert_default().rgb.hsl([
								r,
								g,
								b,
							]) || [0, 0, 0];
					...
					if (HSL_REGEXP.test(value)) {
						let [h, s, l, a] = stringToArgs(value),
							[r, g, b] = color_convert_default().hsl.rgb([
								h,
								s,
								l,
							]) || [0, 0, 0];
				...
				useColorInput = (initialValue, onChange) => {
					let [value, setValue] = (0, react.useState)(
						...
						[color, setColor] = (0, react.useState)(() =>
							parseValue(value),
						),
			...
			(module, __unused_webpack_exports, __webpack_require__) => {
				...
				(convert.rgb.hsl = function (rgb) {
					...
					(convert.hsv.ansi16 = function (args) {
						return convert.rgb.ansi16(
							convert.hsv.rgb(args),
							args[2],
						);
					}),
