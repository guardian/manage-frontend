...
(self.webpackChunkmanage_frontend =
	...
	[7297],
	{
		...
		'./client/components/shared/Header.stories.tsx': (
			__unused_webpack_module,
			__webpack_exports__,
			__webpack_require__,
		) => {
			...
			var _storybook_ReactRouterDecorator__WEBPACK_IMPORTED_MODULE_1__ =
				__webpack_require__('./.storybook/ReactRouterDecorator.tsx');
			...
			var Initial = {},
				SignedOut = { args: { signInStatus: 'signedOut' } },
				SignedIn = { args: { signInStatus: 'signedIn' } };
			(Initial.parameters = {
				...Initial.parameters,
				docs: {
			...
			const __namedExportsOrder = ['Initial', 'SignedOut', 'SignedIn'];
		},
	},
]);
