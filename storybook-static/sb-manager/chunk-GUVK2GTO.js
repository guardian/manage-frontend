					...
					var lang = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
						...
						_ = {
							...
							disableWorkerMessageHandler:
								_self2.Prism &&
								_self2.Prism.disableWorkerMessageHandler,
							util: {
		...
		function bash(Prism) {
			(function (Prism2) {
				...
				for (
					...
					inside[toBeCopied[i]] =
						Prism2.languages.bash[toBeCopied[i]];
...
function getCodeTree(_ref6) {
	...
	if (isHighlightJs(astGenerator)) {
		var hasLanguage = checkForListedLanguage_default(
			astGenerator,
			language,
		);
...
var $921a889cee6df7e8$export$99c2b779aa4e8b8b = (props) => {
	let { present, children } = props,
		...
		ref = $6ed0406888f73fc4$export$c7b2cbe3552a0d052(
			presence.ref,
			child.ref,
		);
...
var $57acba87d6e25586$var$SCROLL_AREA_NAME = 'ScrollArea',
	...
	$57acba87d6e25586$export$ccf8d8d7bbf3c2cc = (0, import_react3.forwardRef)(
		(props, forwardedRef) => {
			let {
				...
				[cornerHeight, setCornerHeight] = (0, import_react3.useState)(
					0,
				),
				[scrollbarXEnabled, setScrollbarXEnabled] = (0,
				import_react3.useState)(!1),
				[scrollbarYEnabled, setScrollbarYEnabled] = (0,
				import_react3.useState)(!1),
	...
	import_react3.forwardRef)((props, forwardedRef) => {
		let { forceMount, ...scrollbarProps } = props,
			...
			[state, send] = $6c2e24571c90391f$export$3e6543de14f8614f(
				'hidden',
				{
	...
	$57acba87d6e25586$var$ScrollAreaScrollbarAuto = (0,
	import_react3.forwardRef)((props, forwardedRef) => {
		...
		return (
			$57acba87d6e25586$var$useResizeObserver(
				context.viewport,
				handleResize,
			),
			$57acba87d6e25586$var$useResizeObserver(
						...
						onThumbPositionChange: () => {
							if (context.viewport && thumbRef.current) {
								let scrollPos = context.viewport.scrollLeft,
									offset =
										$57acba87d6e25586$var$getThumbOffsetFromScroll(
											scrollPos,
											sizes,
											context.dir,
										);
						...
						onDragScroll: (pointerPos) => {
							context.viewport &&
								(context.viewport.scrollLeft =
									getScrollPosition(pointerPos, context.dir));
						},
					}),
			  )
	...
	$57acba87d6e25586$var$ScrollAreaScrollbarX = (0, import_react3.forwardRef)(
		(props, forwardedRef) => {
			let { sizes, onSizesChange, ...scrollbarProps } = props,
				...
				[computedStyle, setComputedStyle] = (0,
				import_react3.useState)(),
				ref = (0, import_react3.useRef)(null),
						...
						scrollbarProps,
						{
							...
							style: {
								...
								'--radix-scroll-area-thumb-width':
									$57acba87d6e25586$var$getThumbSize(sizes) +
									'px',
								...props.style,
							},
							onThumbPointerDown: (pointerPos) =>
	...
	$57acba87d6e25586$var$ScrollAreaScrollbarImpl = (0,
	import_react3.forwardRef)((props, forwardedRef) => {
		let {
				__scopeScrollArea,
				sizes,
		...
		(props, forwardedRef) => {
			...
			return (
				...
				(0, import_react3.createElement)(
					...
					_extends(
						{
							'data-state': scrollbarContext.hasThumb
								? 'visible'
								: 'hidden',
						},
						thumbProps,
			...
			return (
				$57acba87d6e25586$var$useResizeObserver(
					...
					() => {
						...
						let height =
							((_context$scrollbarX = context.scrollbarX) ===
								null || _context$scrollbarX === void 0
								? void 0
				...
				$57acba87d6e25586$var$useResizeObserver(
					...
					() => {
						...
						let width =
							((_context$scrollbarY = context.scrollbarY) ===
								null || _context$scrollbarY === void 0
								? void 0
	...
	ScrollAreaScrollbar = newStyled($57acba87d6e25586$export$9a4e88b92edfce6b)(
		({ offset, horizontal, vertical }) => ({
			...
			'&[data-orientation="vertical"]': {
				...
				marginTop: offset,
				marginBottom:
					horizontal === 'true' && vertical === 'true' ? 0 : offset,
			},
			'&[data-orientation="horizontal"]': {
...
var Wrapper = newStyled.div(
	...
	SyntaxHighlighter2 = ({
		...
		let [highlightableCode, setHighlightableCode] = (0,
		import_react3.useState)('');
		(0, import_react3.useEffect)(() => {
			formatter
