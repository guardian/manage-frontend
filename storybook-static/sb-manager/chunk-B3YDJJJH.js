			...
			function printWarning(level, format2, args) {
				{
					...
					stack !== '' &&
						((format2 += '%s'), (args = args.concat([stack])));
				...
				if (enqueueTaskImpl === null)
					try {
						var requireString = ('require' + Math.random()).slice(
							...
							nodeRequire = module && module[requireString];
			...
			function siftDown(heap, node2, i) {
				for (
					...
					if (compare(left, node2) < 0)
						rightIndex < length2 && compare(right, left) < 0
							? ((heap[index] = right),
	...
	'../../node_modules/react-dom/cjs/react-dom.development.js'(exports) {
		...
		(function () {
			...
			var FunctionComponent = 0,
				...
				enableClientRenderFallbackOnTextMismatch = !0,
				enableNewReconciler = !1,
				enableLazyContextPropagation = !1,
				enableLegacyHidden = !1,
				enableSuspenseAvoidThisFallback = !1,
				disableCommentsAsDOMContainers = !0,
				enableCustomElementPropertySupport = !1,
				warnAboutStringRefs = !1,
				enableSchedulingProfiler = !0,
				enableProfilerTimer = !0,
				enableProfilerCommitHooks = !0,
				...
				if (
					...
					if (value === null) node2.removeAttribute(attributeName);
						...
						var _type = propertyInfo.type,
							attributeValue;
						_type === BOOLEAN ||
						(_type === OVERLOADED_BOOLEAN && value === !0)
							? (attributeValue = '')
			...
			var REACT_ELEMENT_TYPE = Symbol.for('react.element'),
				...
				REACT_DEBUG_TRACING_MODE_TYPE = Symbol.for(
...
` +
			...
			function getComponentNameFromFiber(fiber) {
				...
				switch (tag) {
					...
					case ContextProvider:
						var provider = type;
						return (
							getContextName$1(provider._context) + '.Provider'
						);
					...
					case Mode:
						return type === REACT_STRICT_MODE_TYPE
							? 'StrictMode'
							: 'Mode';
			...
			function updateChecked(element, props) {
				var node2 = element,
					checked = props.checked;
				checked != null &&
					setValueForProperty(node2, 'checked', checked, !1);
			}
			...
			function postMountWrapper(element, props, isHydrating2) {
				...
				name !== '' && (node2.name = ''),
					...
					(node2.defaultChecked =
						!!node2._wrapperState.initialChecked),
...
Check the render method of \`` +
			...
			function getHostProps$1(element, props) {
				return assign2({}, props, { value: void 0 });
			}
			...
			var createMicrosoftUnsafeLocalFunction = function (func) {
				...
				setInnerHTML = createMicrosoftUnsafeLocalFunction(function (
					...
					if (
						node2.namespaceURI === SVG_NAMESPACE &&
						!('innerHTML' in node2)
					) {
						(reusableSVGContainer =
							reusableSVGContainer ||
			...
			var omittedCloseTags = {
				...
				voidElementTags = assign2({ menuitem: !0 }, omittedCloseTags),
				HTML = '__html';
			...
			function rethrowCaughtError() {
				if (hasRethrowError) {
					...
					throw (
						((hasRethrowError = !1), (rethrowError = null), error2)
					);
				}
			}
			...
			var NoFlags = 0,
				...
				Callback = 64,
				DidCapture = 128,
				ForceClientRender = 256,
				Ref = 512,
				Snapshot = 1024,
				Passive = 2048,
				Hydrating = 4096,
				Visibility = 8192,
				StoreConsistency = 16384,
				LifecycleEffectMask =
					Passive |
					Update |
					Callback |
					...
					Snapshot |
					StoreConsistency,
				HostEffectMask = 32767,
				Incomplete = 32768,
				ShouldCapture = 65536,
				ForceUpdateForLegacySuspense = 131072,
				Forked = 1048576,
				RefStatic = 2097152,
				LayoutStatic = 4194304,
				PassiveStatic = 8388608,
				MountLayoutDev = 16777216,
				MountPassiveDev = 33554432,
				BeforeMutationMask = Update | Snapshot | 0,
				MutationMask =
					Placement |
					Update |
					ChildDeletion |
			...
			function getNearestMountedFiber(fiber) {
				...
				if (fiber.alternate)
					for (; node2.return; ) node2 = node2.return;
				else {
					var nextNode = node2;
					do
						(node2 = nextNode),
							(node2.flags & (Placement | Hydrating)) !==
								NoFlags && (nearestMounted = node2.return),
			...
			var scheduleCallback = Scheduler.unstable_scheduleCallback,
				...
				unstable_yieldValue = Scheduler.unstable_yieldValue,
			...
			function onCommitRoot(root2, eventPriority) {
				if (
					...
					try {
						var didError =
							(root2.current.flags & DidCapture) === DidCapture;
			...
			function setIsStrictModeForDevtools(newIsStrictMode) {
				if (
					(typeof unstable_yieldValue == 'function' &&
			...
			function getLaneLabelMap() {
				{
					for (
						var map = new Map(), lane = 1, index2 = 0;
						index2 < TotalLanes;
						index2++
					) {
			...
			var TotalLanes = 31,
				...
				TransitionLanes = 4194240,
				TransitionLane1 = 64,
				TransitionLane2 = 128,
				TransitionLane3 = 256,
				TransitionLane4 = 512,
				TransitionLane5 = 1024,
				TransitionLane6 = 2048,
				TransitionLane7 = 4096,
				TransitionLane8 = 8192,
				TransitionLane9 = 16384,
				TransitionLane10 = 32768,
				TransitionLane11 = 65536,
				TransitionLane12 = 131072,
				TransitionLane13 = 262144,
				TransitionLane14 = 524288,
				TransitionLane15 = 1048576,
				TransitionLane16 = 2097152,
				RetryLanes = 130023424,
				RetryLane1 = 4194304,
				RetryLane2 = 8388608,
				RetryLane3 = 16777216,
				RetryLane4 = 33554432,
				...
				SelectiveHydrationLane = 134217728,
				NonIdleLanes = 268435455,
				IdleHydrationLane = 268435456,
				IdleLane = 536870912,
			...
			function getNextLanes(root2, wipLanes) {
				...
				var nextLanes = NoLanes,
					...
					nonIdlePendingLanes = pendingLanes & NonIdleLanes;
				...
				if (
					...
					var nextLane = getHighestPriorityLane(nextLanes),
						wipLane = getHighestPriorityLane(wipLanes);
					if (
						nextLane >= wipLane ||
			...
			function getLanesToRetrySynchronouslyOnError(root2) {
				...
				return everythingButOffscreen !== NoLanes
					...
					: everythingButOffscreen & OffscreenLane
					? OffscreenLane
					: NoLanes;
			}
			...
			function claimNextTransitionLane() {
				...
				return (
					...
					(nextTransitionLane & TransitionLanes) === NoLanes &&
						(nextTransitionLane = TransitionLane1),
					lane
				);
			}
			function claimNextRetryLane() {
				...
				return (
					(nextRetryLane <<= 1),
					(nextRetryLane & RetryLanes) === NoLanes &&
						(nextRetryLane = RetryLane1),
					lane
				);
			}
			...
			function markRootEntangled(root2, entangledLanes) {
				for (
					var rootEntangledLanes = (root2.entangledLanes |=
							entangledLanes),
						entanglements = root2.entanglements,
						lanes = rootEntangledLanes;
					lanes;
			...
			function getBumpedLaneForHydration(root2, renderLanes2) {
				...
				return (lane & (root2.suspendedLanes | renderLanes2)) !== NoLane
					? NoLane
					: lane;
			}
				...
				if (isDevToolsPresent)
					for (
						var pendingUpdatersLaneMap =
							root2.pendingUpdatersLaneMap;
						lanes > 0;

					) {
						var index2 = laneToIndex(lanes),
							lane = 1 << index2,
							updaters = pendingUpdatersLaneMap[index2];
			...
			function lanesToEventPriority(lanes) {
				...
				return isHigherEventPriority(DiscreteEventPriority, lane)
					? isHigherEventPriority(ContinuousEventPriority, lane)
						? includesNonIdleWork(lane)
			...
			function queueExplicitHydrationTarget(target) {
				...
				queuedExplicitHydrationTargets.splice(i, 0, queuedTarget),
					i === 0 && attemptExplicitHydrationTarget(queuedTarget);
			}
				...
				for (
					...
					if (nextBlockedOn === null) {
						var nativeEvent = queuedEvent.nativeEvent,
							nativeEventClone = new nativeEvent.constructor(
								nativeEvent.type,
								nativeEvent,
							);
			...
			function attemptReplayContinuousQueuedEventInMap(
				...
				attemptReplayContinuousQueuedEvent(queuedEvent) &&
					map.delete(key);
			}
			...
			function addEventBubbleListener(target, eventType, listener) {
				return (
					target.addEventListener(eventType, listener, !1), listener
				);
			}
			function addEventCaptureListener(target, eventType, listener) {
				return (
					target.addEventListener(eventType, listener, !0), listener
				);
			}
			...
			function getData() {
				...
				for (
					start = 0;
					start < startLength &&
					startValue[start] === endValue[start];
					start++
				);
			...
			var EventInterface = {
				...
				UIEventInterface = assign2({}, EventInterface, {
					view: 0,
					detail: 0,
				}),
			...
			var MouseEventInterface = assign2({}, UIEventInterface, {
				...
				DragEventInterface = assign2({}, MouseEventInterface, {
					dataTransfer: 0,
				}),
				SyntheticDragEvent = createSyntheticEvent(DragEventInterface),
				FocusEventInterface = assign2({}, UIEventInterface, {
					relatedTarget: 0,
				}),
				...
				CompositionEventInterface = assign2({}, EventInterface, {
					data: 0,
				}),
			...
			function getEventKey(nativeEvent) {
				...
				return nativeEvent.type === 'keydown' ||
			...
			function extractCompositionEvent(
				...
				if (listeners.length > 0) {
					...
					if (
						(dispatchQueue.push({ event, listeners }), fallbackData)
					)
				...
				if (!(!isOutEvent && !isOverEvent)) {
					...
					if (from2 !== to) {
						...
						var fromNode =
								from2 == null
									? win
									: getNodeFromInstance(from2),
							toNode = to == null ? win : getNodeFromInstance(to),
			...
			function isSameOriginFrame(iframe) {
				try {
					return (
						typeof iframe.contentWindow.location.href == 'string'
					);
				} catch {
					return !1;
				}
			...
			function getSelection$1(node2) {
				if (
					'selectionStart' in node2 &&
					hasSelectionCapabilities(node2)
				)
					return {
			...
			function listenToNonDelegatedEvent(domEventName, targetElement) {
				...
				var isCapturePhaseListener = !1,
					listenerSet = getEventListenerSet(targetElement),
			...
			(warnedUnknownTags = { dialog: !0, webview: !0 }),
				...
				(normalizeHTML = function (parent, html) {
					...
					return (
						(testElement.innerHTML = html), testElement.innerHTML
					);
				});
...
`,
			...
			function diffProperties(
				...
				for (propKey in nextProps) {
					...
					if (
						...
						if (propKey === STYLE)
							if (
								(nextProp && Object.freeze(nextProp), lastProp)
							) {
			...
			function getCurrentEventPriority() {
				...
				return currentEvent === void 0
					? DefaultEventPriority
					: getEventPriority(currentEvent.type);
			}
			var scheduleTimeout =
			...
			function clearSuspenseBoundary(parentInstance, suspenseInstance) {
				...
				do {
					...
					if (
						...
						nextNode && nextNode.nodeType === COMMENT_NODE)
					) {
			...
			function getNextHydratableInstanceAfterSuspenseInstance(
				...
				for (
					var node2 = suspenseInstance.nextSibling, depth = 0;
					node2;
			...
			function getParentSuspenseInstance(targetInstance) {
				for (
					var node2 = targetInstance.previousSibling, depth = 0;
					node2;
			...
			function getUnmaskedContext(
				...
				return didPushOwnContextIfProvider &&
			...
			function flushSyncCallbacks() {
				if (!isFlushingSyncQueue && syncQueue !== null) {
					...
					var i = 0,
						previousUpdatePriority = getCurrentUpdatePriority();
					try {
						var isSync = !0,
							queue = syncQueue;
						for (
			...
			function isForkedChild(workInProgress2) {
				return (
					warnIfNotHydrating(),
					(workInProgress2.flags & Forked) !== NoFlags
				);
			}
			...
			function getTreeId() {
				var overflow = treeContextOverflow,
					...
					id = idWithLeadingBit & ~getLeadingBit(idWithLeadingBit);
			...
			function pushTreeId(workInProgress2, totalChildren, index2) {
				...
				var baseIdWithLeadingBit = treeContextId,
					...
					baseLength = getBitLength(baseIdWithLeadingBit) - 1,
					baseId = baseIdWithLeadingBit & ~(1 << baseLength),
					slot = index2 + 1,
					length2 = getBitLength(totalChildren) + baseLength;
				if (length2 > 30) {
					var numberOfOverflowBits = baseLength - (baseLength % 5),
						newOverflowBits = (1 << numberOfOverflowBits) - 1,
						newOverflow = (baseId & newOverflowBits).toString(32),
						restOfBaseId = baseId >> numberOfOverflowBits,
						restOfBaseLength = baseLength - numberOfOverflowBits,
						restOfLength =
							getBitLength(totalChildren) + restOfBaseLength,
						restOfNewBits = slot << restOfBaseLength,
						id = restOfNewBits | restOfBaseId,
						overflow = newOverflow + baseOverflow;
					(treeContextId = (1 << restOfLength) | id),
						(treeContextOverflow = overflow);
				} else {
					var newBits = slot << baseLength,
						_id = newBits | baseId,
						_overflow = baseOverflow;
			...
			function warnNonhydratedInstance(returnFiber, fiber) {
				{
					...
					switch (returnFiber.tag) {
						...
						case SuspenseComponent: {
							var suspenseState = returnFiber.memoizedState,
								_parentInstance = suspenseState.dehydrated;
							if (_parentInstance !== null)
								switch (fiber.tag) {
									case HostComponent:
										var _type2 = fiber.type,
											_props2 = fiber.pendingProps;
			...
			function tryToClaimNextHydratableInstance(fiber) {
				if (isHydrating) {
					...
					if (!nextInstance) {
						shouldClientRenderOnMismatch(fiber) &&
			...
			function prepareToHydrateHostInstance(
				...
				var instance = fiber.stateNode,
					shouldWarnIfMismatchDev = !didSuspendOrErrorDEV,
				...
				return (
					(fiber.updateQueue = updatePayload), updatePayload !== null
				);
			}
			...
			};
			{
				var findStrictRoot = function (fiber) {
						for (
							var maybeStrictRoot = null, node2 = fiber;
							node2 !== null;

						)
							node2.mode & StrictLegacyMode &&
...
Learn more about this warning here: https://reactjs.org/link/legacy-context`,
			...
			function scheduleContextWorkOnParentPath(
				...
				for (var node2 = parent; node2 !== null; ) {
					...
					if (
						(isSubsetOfLanes(node2.childLanes, renderLanes2)
							? alternate !== null &&
							  !isSubsetOfLanes(
			...
			function prepareToReadContext(workInProgress2, renderLanes2) {
				...
				if (dependencies !== null) {
					...
					firstContext !== null &&
						(includesSomeLane(dependencies.lanes, renderLanes2) &&
				...
				if (concurrentQueues !== null) {
					for (var i = 0; i < concurrentQueues.length; i++) {
						var queue = concurrentQueues[i],
							lastInterleavedUpdate = queue.interleaved;
						if (lastInterleavedUpdate !== null) {
							queue.interleaved = null;
							var firstInterleavedUpdate =
									lastInterleavedUpdate.next,
								lastPendingUpdate = queue.pending;
			...
			function markUpdateLaneFromFiberToRoot(sourceFiber, lane) {
				...
				for (
					var node2 = sourceFiber, parent = sourceFiber.return;
					parent !== null;
			...
			function processUpdateQueue(
				...
				if (firstBaseUpdate !== null) {
					...
					newLastBaseUpdate === null && (newBaseState = newState),
					...
					if (typeof instance.componentDidMount == 'function') {
						...
						(fiberFlags |= LayoutStatic),
							(workInProgress2.mode & StrictEffectsMode) !==
								NoMode && (fiberFlags |= MountLayoutDev),
							(workInProgress2.flags |= fiberFlags);
					}
					return !1;
				}
				...
				if (shouldUpdate) {
					if (
						...
						(_fiberFlags |= LayoutStatic),
							(workInProgress2.mode & StrictEffectsMode) !==
								NoMode && (_fiberFlags |= MountLayoutDev),
					...
					if (typeof instance.componentDidMount == 'function') {
						...
						(_fiberFlags2 |= LayoutStatic),
							(workInProgress2.mode & StrictEffectsMode) !==
								NoMode && (_fiberFlags2 |= MountLayoutDev),
...
See https://reactjs.org/link/refs-must-have-owner for more information.`,
					...
					if (typeof newChild == 'object' && newChild !== null) {
						switch (newChild.$$typeof) {
							...
							case REACT_PORTAL_TYPE: {
								...
								return (
									(_created2.return = returnFiber), _created2
								);
							}
							case REACT_LAZY_TYPE: {
			...
			function registerMutableSourceForHydration(root2, mutableSource) {
				var getVersion = mutableSource._getVersion,
					version = getVersion(mutableSource._source);
				root2.mutableSourceEagerHydrationData == null
...
Incoming: %s`,
			...
			function mountSyncExternalStore(
				...
				if (isHydrating2) {
					...
					includesBlockingLane(root2, renderLanes) ||
			...
			function updateSyncExternalStore(
				...
				var prevSnapshot = hook.memoizedState,
					snapshotChanged = !objectIs(prevSnapshot, nextSnapshot);
				snapshotChanged &&
					((hook.memoizedState = nextSnapshot),
					markWorkInProgressReceivedUpdate());
				var inst = hook.queue;
			...
			function mountEffect(create3, deps) {
				return (currentlyRenderingFiber$1.mode & StrictEffectsMode) !==
					NoMode
					? mountEffectImpl(
			...
			function mountInsertionEffect(create3, deps) {
				return mountEffectImpl(Update, Insertion2, create3, deps);
			}
			function updateInsertionEffect(create3, deps) {
				return updateEffectImpl(Update, Insertion2, create3, deps);
			}
			function mountLayoutEffect(create3, deps) {
				...
				return (
					...
					(currentlyRenderingFiber$1.mode & StrictEffectsMode) !==
						NoMode && (fiberFlags |= MountLayoutDev),
					mountEffectImpl(fiberFlags, Layout, create3, deps)
				);
			}
			...
			function updateDeferredValue(value) {
				var hook = updateWorkInProgressHook(),
					...
					prevValue = resolvedCurrentHook.memoizedState;
			...
			function mountId() {
				var hook = mountWorkInProgressHook(),
					root2 = getWorkInProgressRoot(),
					identifierPrefix = root2.identifierPrefix,
					id;
				if (getIsHydrating()) {
					var treeId = getTreeId();
					id = ':' + identifierPrefix + 'R' + treeId;
					var localId = localIdCounter++;
					localId > 0 && (id += 'H' + localId.toString(32)),
						(id += ':');
				} else {
				...
				(HooksDispatcherOnMountInDEV = {
					...
					useInsertionEffect: function (create3, deps) {
						return (
							...
							mountHookTypesDev(),
							checkDepsAreArrayDev(deps),
							mountInsertionEffect(create3, deps)
						);
					},
					...
					(HooksDispatcherOnUpdateInDEV = {
						...
						useInsertionEffect: function (create3, deps) {
							return (
								(currentHookNameInDev = 'useInsertionEffect'),
								updateHookTypesDev(),
								updateInsertionEffect(create3, deps)
							);
						},
						useLayoutEffect: function (create3, deps) {
							return (
						...
						useSyncExternalStore: function (
							...
							return (
								(currentHookNameInDev = 'useSyncExternalStore'),
								updateHookTypesDev(),
								updateSyncExternalStore(subscribe, getSnapshot)
							);
						},
						useId: function () {
							return (
					...
					(InvalidNestedHooksDispatcherOnMountInDEV = {
						readContext: function (context) {
							return (
								warnInvalidContextAccess(), readContext(context)
							);
						},
						useCallback: function (callback, deps) {
							return (
...
` +
				...
				if (
					...
					if (suspenseBoundary !== null) {
						(suspenseBoundary.flags &= ~ForceClientRender),
							...
							suspenseBoundary.mode & ConcurrentMode &&
								attachPingListener(
									root2,
									wakeable,
									rootRenderLanes,
					...
					if (_suspenseBoundary !== null) {
						(_suspenseBoundary.flags & ShouldCapture) === NoFlags &&
			...
			function updateOffscreenComponent(
				...
				if (nextProps.mode === 'hidden' || enableLegacyHidden)
					if ((workInProgress2.mode & ConcurrentMode) === NoMode) {
						...
						} else nextBaseLanes = renderLanes2;
					...
					switch (shouldError(workInProgress2)) {
						case !1: {
							var _instance = workInProgress2.stateNode,
								ctor = workInProgress2.type,
								tempInstance = new ctor(
									workInProgress2.memoizedProps,
									_instance.context,
								),
								state = tempInstance.state;
						...
						case !0: {
							...
							var error$1 = new Error(
								...
								lane = pickArbitraryLane(renderLanes2);
							workInProgress2.lanes = mergeLanes(
								workInProgress2.lanes,
								lane,
							);
			...
			function updateHostRoot(current2, workInProgress2, renderLanes2) {
				...
				var nextState = workInProgress2.memoizedState,
					root2 = workInProgress2.stateNode,
...
Check the render method of \`` +
			...
			function shouldRemainOnFallback(
				...
				if (current2 !== null) {
					...
					if (suspenseState === null) return !1;
				}
				...
				if (
					...
					if (showFallback) {
						var fallbackFragment = mountSuspenseFallbackChildren(
							...
							primaryChildFragment = workInProgress2.child;
						return (
					...
					if (showFallback) {
						var _nextFallbackChildren = nextProps.fallback,
							_nextPrimaryChildren = nextProps.children,
							...
							_primaryChildFragment2 = workInProgress2.child,
							prevOffscreenState = current2.child.memoizedState;
						return (
			...
			function mountSuspenseFallbackChildren(
				...
				var mode = workInProgress2.mode,
					progressedPrimaryFragment = workInProgress2.child,
					primaryChildProps = {
						mode: 'hidden',
						children: primaryChildren,
					},
			...
			function updateSuspensePrimaryChildren(
				...
				if (
					...
					currentFallbackChildFragment !== null)
				) {
			...
			function updateSuspenseFallbackChildren(
				...
				var mode = workInProgress2.mode,
					currentPrimaryChildFragment = current2.child,
					currentFallbackChildFragment =
						currentPrimaryChildFragment.sibling,
					primaryChildProps = {
						mode: 'hidden',
			...
			function retrySuspenseComponentWithoutHydrating(
				...
				var nextProps = workInProgress2.pendingProps,
					primaryChildren = nextProps.children,
				...
				return (
					(workInProgress2.mode & ConcurrentMode) === NoMode
						? (error(
						  ...
						  (workInProgress2.lanes = SyncLane))
						: isSuspenseInstanceFallback(suspenseInstance)
						? (workInProgress2.lanes = DefaultHydrationLane)
						: (workInProgress2.lanes = OffscreenLane),
					null
				);
			}
				...
				if (didSuspend)
					if (workInProgress2.flags & ForceClientRender) {
						...
						var nextPrimaryChildren = nextProps.children,
							...
							_primaryChildFragment4 = workInProgress2.child;
						return (
					...
					if (didReceiveUpdate || hasContextChanged2) {
						...
						if (root2 !== null) {
							var attemptHydrationAtLane =
								getBumpedLaneForHydration(root2, renderLanes2);
							if (
			...
			function bailoutOnAlreadyFinishedWork(
				...
				return (
					...
					includesSomeLane(renderLanes2, workInProgress2.childLanes)
			...
			function beginWork(current2, workInProgress2, renderLanes2) {
				...
				if (current2 !== null) {
					...
					((didReceiveUpdate = !1),
					getIsHydrating() && isForkedChild(workInProgress2))
				) {
					var slotIndex = workInProgress2.index,
						numberOfForks = getForksAtLevel();
					pushTreeId(workInProgress2, numberOfForks, slotIndex);
				}
				switch (
					((workInProgress2.lanes = NoLanes), workInProgress2.tag)
				) {
					case IndeterminateComponent:
			...
			function completeDehydratedSuspenseBoundary(
				...
				else return upgradeHydrationErrorsToRecoverable(), !0;
			}
			function completeWork(current2, workInProgress2, renderLanes2) {
				var newProps = workInProgress2.pendingProps;
				switch (
					(popTreeContext(workInProgress2), workInProgress2.tag)
				) {
					case IndeterminateComponent:
					case LazyComponent:
					case SimpleMemoComponent:
					...
					case HostRoot: {
						...
						if (
							...
							if (wasHydrated) markUpdate(workInProgress2);
					...
					case SuspenseComponent: {
						...
						if (
							...
							if (!fallthroughToNormalSuspensePath)
								return workInProgress2.flags & ShouldCapture
									? workInProgress2
									: null;
						}
					...
					case LegacyHiddenComponent: {
						...
						var _nextState = workInProgress2.memoizedState,
							nextIsHidden = _nextState !== null;
						if (current2 !== null) {
							var _prevState = current2.memoizedState,
								prevIsHidden = _prevState !== null;
			...
			function unwindWork(current2, workInProgress2, renderLanes2) {
				switch (
					...
					case HostRoot: {
						...
						return (_flags & ShouldCapture) !== NoFlags &&
			...
			function unwindInterruptedWork(
				...
				switch (
					(popTreeContext(interruptedWork), interruptedWork.tag)
				) {
					case ClassComponent: {
						...
						if ((effect.tag & flags) === flags) {
									  ...
									  markComponentLayoutEffectMountStopped();
							{
								...
								if (
									...
									var hookName = void 0;
									(effect.tag & Layout) !== NoFlags
										? (hookName = 'useLayoutEffect')
										: (effect.tag & Insertion2) !== NoFlags
...
Learn more about data fetching with Hooks: https://reactjs.org/link/hooks-data-fetching`)
			...
			function commitLayoutEffectOnFiber(
				...
				offscreenSubtreeWasHidden ||
					(finishedWork.flags & Ref && commitAttachRef(finishedWork));
			}
			...
			function hideOrUnhideAllChildren(finishedWork, isHidden) {
				for (var hostSubtreeRoot = null, node2 = finishedWork; ; ) {
					...
					for (; node2.sibling === null; ) {
						if (
							node2.return === null ||
							node2.return === finishedWork
						)
							return;
						hostSubtreeRoot === node2 && (hostSubtreeRoot = null),
							(node2 = node2.return);
					}
					hostSubtreeRoot === node2 && (hostSubtreeRoot = null),
						(node2.sibling.return = node2.return),
			...
			function getHostSibling(fiber) {
				...
				siblings: for (;;) {
					...
					if (!(node2.flags & Placement)) return node2.stateNode;
				}
			}
					...
					case SuspenseComponent: {
						...
						if (offscreenFiber.flags & Visibility) {
							var offscreenInstance = offscreenFiber.stateNode,
								newState = offscreenFiber.memoizedState,
								isHidden = newState !== null;
							if (
								...
								var wasHidden =
									...
									offscreenFiber.alternate.memoizedState !==
										null;
					...
					case OffscreenComponent: {
						...
						if (
							...
							var _offscreenInstance = finishedWork.stateNode,
								_newState = finishedWork.memoizedState,
								_isHidden = _newState !== null,
								offscreenBoundary = finishedWork;
							if (
			...
			var ceil = Math.ceil,
				...
				subtreeRenderLanesCursor = createCursor(NoLanes),
			...
			function requestRetryLane(fiber) {
				var mode = fiber.mode;
				return (mode & ConcurrentMode) === NoMode
					? SyncLane
					: claimNextRetryLane();
			}
			...
			function ensureRootIsScheduled(root2, currentTime) {
				...
				var newCallbackPriority = getHighestPriorityLane(nextLanes),
					existingCallbackPriority = root2.callbackPriority;
				if (
				...
				if (newCallbackPriority === SyncLane)
					root2.tag === LegacyRoot
						? (ReactCurrentActQueue$1.isBatchingLegacy !== null &&
								(ReactCurrentActQueue$1.didScheduleLegacyUpdate =
									!0),
				...
				if (exitStatus !== RootInProgress) {
					...
					if (exitStatus === RootDidNotComplete)
						...
						var renderWasConcurrent = !includesBlockingLane(
							...
							finishedWork = root2.current.alternate;
						if (
							renderWasConcurrent &&
			...
			function isRenderConsistentWithExternalStores(finishedWork) {
				for (var node2 = finishedWork; ; ) {
					...
					var child = node2.child;
					if (
						node2.subtreeFlags & StoreConsistency &&
						child !== null
					) {
						(child.return = node2), (node2 = child);
						continue;
					}
					if (node2 === finishedWork) return !0;
					for (; node2.sibling === null; ) {
						if (
							node2.return === null ||
							node2.return === finishedWork
				...
				do {
					...
					try {
						if (
							...
							erroredWork === null || erroredWork.return === null)
						) {
			...
			function renderRootConcurrent(root2, lanes) {
				...
				return (
					...
					(executionContext = prevExecutionContext),
					workInProgress !== null
						? (markRenderYielded(), RootInProgress)
						: (markRenderStopped(),
						  (workInProgressRoot = null),
						  (workInProgressRootRenderLanes = NoLanes),
						  workInProgressRootExitStatus)
			...
			function commitRootImpl(
				...
				if (subtreeHasEffects || rootHasEffect) {
					...
					recordCommitTime(),
						...
						setCurrentUpdatePriority(previousPriority),
						(ReactCurrentBatchConfig$3.transition = prevTransition);
				} else (root2.current = finishedWork), recordCommitTime();
				...
				if (
					...
					for (
						...
						var recoverableError = recoverableErrors[i],
							...
							digest = recoverableError.digest;
				...
				return (
					includesSomeLane(pendingPassiveEffectsLanes, SyncLane) &&
						...
						flushPassiveEffects(),
					(remainingLanes = root2.pendingLanes),
					includesSomeLane(remainingLanes, SyncLane)
			...
			function flushPassiveEffectsImpl() {
				...
				markPassiveEffectsStopped(),
					commitDoubleInvokeEffectsInDEV(root2.current, !0),
					(executionContext = prevExecutionContext),
					flushSyncCallbacks(),
					didScheduleUpdateDuringPassiveEffects
						? root2 === rootWithPassiveNestedUpdates
			...
			function captureCommitPhaseErrorOnRoot(
				...
				var errorInfo = createCapturedValueAtFiber(error2, sourceFiber),
					...
					root2 = enqueueUpdate(rootFiber, update, SyncLane),
					eventTime = requestEventTime();
				root2 !== null &&
					...
					if (fiber.tag === HostRoot) {
						...
						if (
							...
							var errorInfo = createCapturedValueAtFiber(
								...
								root2 = enqueueUpdate(fiber, update, SyncLane),
								eventTime = requestEventTime();
							root2 !== null &&
								(markRootUpdated(root2, SyncLane, eventTime),
								ensureRootIsScheduled(root2, eventTime));
...
%s`,
			...
			function retryTimedOutBoundary(boundaryFiber, retryLane) {
				...
				var eventTime = requestEventTime(),
					root2 = enqueueConcurrentRenderForLane(
						boundaryFiber,
						retryLane,
					);
				root2 !== null &&
			...
			function invokeEffectsInDev(
				...
				for (
					...
					primarySubtreeFlag !== NoFlags
						...
						: ((current2.flags & fiberFlags) !== NoFlags &&
...
Check the render method of \`` +
			...
			function createFiberFromOffscreen(pendingProps, mode, lanes, key) {
				...
				(fiber.elementType = REACT_OFFSCREEN_TYPE),
					(fiber.lanes = lanes);
				var primaryChildInstance = { isHidden: !1 };
			...
			function createFiberRoot(
				...
				var root2 = new FiberRootNode(
					...
					uninitializedFiber = createHostRootFiber(tag, isStrictMode);
...
Check the render method of %s.`,
			...
			function attemptContinuousHydration$1(fiber) {
				if (fiber.tag === SuspenseComponent) {
					var lane = SelectiveHydrationLane,
						root2 = enqueueConcurrentRenderForLane(fiber, lane);
					if (root2 !== null) {
						var eventTime = requestEventTime();
						scheduleUpdateOnFiber(root2, fiber, lane, eventTime);
					}
  ...
  root.render(<App />);`),
					options2.unstable_strictMode === !0 && (isStrictMode = !0),
					options2.identifierPrefix !== void 0 &&
						(identifierPrefix = options2.identifierPrefix),
					options2.onRecoverableError !== void 0 &&
						(onRecoverableError = options2.onRecoverableError),
					options2.transitionCallbacks !== void 0 &&
			...
			function hydrateRoot(container, initialChildren, options2) {
				...
				var hydrationCallbacks = options2 ?? null,
					mutableSources =
			...
			function hydrateRoot$1(container, initialChildren, options2) {
				return (
					...
					hydrateRoot(container, initialChildren, options2)
				);
			}
		...
		'../../node_modules/react-is/cjs/react-is.development.js'(exports) {
			(function () {
				var hasSymbol = typeof Symbol == 'function' && Symbol.for,
					REACT_ELEMENT_TYPE = hasSymbol
						? Symbol.for('react.element')
						: 60103,
					REACT_PORTAL_TYPE = hasSymbol
					...
					REACT_SUSPENSE_LIST_TYPE = hasSymbol
						...
						: 60120,
					REACT_MEMO_TYPE = hasSymbol
						? Symbol.for('react.memo')
						: 60115,
					REACT_LAZY_TYPE = hasSymbol
						? Symbol.for('react.lazy')
						: 60116,
					REACT_BLOCK_TYPE = hasSymbol
...
var StyleSheet = (function () {
		function StyleSheet2(options) {
			...
			(this._insertTag = function (tag) {
				...
				(this.isSpeedy =
					options.speedy === void 0 ? !1 : options.speedy),
				(this.tags = []),
				(this.ctr = 0),
...
var weakMemoize = function (func) {
	...
	compat = function (element) {
		if (
			!(element.type !== 'rule' || !element.parent || element.length < 1)
		) {
			for (
