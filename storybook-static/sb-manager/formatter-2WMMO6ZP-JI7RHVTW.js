...
function Ci(t8) {
	var e;
	return (e = t8.children) == null
		? void 0
		: e.some((r) => r.type !== 'text');
}
function Tn(t8) {
	if (t8)
		switch (t8) {
...
function kn(t8) {
	return (
		(t8.type === 'element' && (!t8.namespace || de(t8)) && dn[t8.name]) ||
		mn
	);
}
function Ti(t8) {
...
function Dt(t8, e) {
	return (
		Ce(t8, e) &&
		(Ke(t8, e) || (t8.attrMap.lang && t8.attrMap.lang !== 'html'))
	);
}
function Bn(t8) {
	let e = t8.fullName;
		...
		Cr.has(r) ||
			Cr.set(
				...
				r.children.some(
					(n) =>
						yt(n, e) &&
						['ts', 'typescript'].includes(n.attrMap.lang),
				),
			),
		Cr.get(r)
	);
...
function Ps(t8, e, r, n = {}) {
	...
	return (
		s.tokenize(),
		new Fr(lo(s.tokens), s.errors, s.nonNormalizedIcuExpressions)
	);
}
var ro = /\r\n?/g;
function Ue(t8) {
	return `Unexpected character "${
		t8 === 0 ? 'EOF' : String.fromCharCode(t8)
	}"`;
}
function ws(t8) {
...
`,
		...
		_attemptCharCode(e) {
			return this._cursor.peek() === e
				? (this._cursor.advance(), !0)
				: !1;
		}
		_attemptCharCodeCaseInsensitive(e) {
			return uo(this._cursor.peek(), e)
				? (this._cursor.advance(), !0)
				: !1;
		}
		_requireCharCode(e) {
			...
			for (let i = this._containerStack.length - 1; i >= 0; i--) {
				...
				if (
					Me(a.name)
						? a.name === e
						: (e == null ||
								a.name.toLowerCase() === e.toLowerCase()) &&
						  a instanceof r
				)
					return (
						(a.endSourceSpan = n),
						(a.sourceSpan.end =
							n !== null ? n.end : a.sourceSpan.end),
		...
		let g,
			...
			$ = (w2) =>
				y2().rootNodes.find(
					({ startSourceSpan: q2 }) =>
						q2 &&
						q2.start.offset === w2.startSourceSpan.start.offset,
				) ?? w2;
...
function Ao(t8, e) {
	...
	let r =
		(n = t8.attrs.find((s) => s.name === 'lang')) == null
			? void 0
			: n.value;
			...
			switch (i) {
				...
				case _:
					if (n && u.expandedStates)
						for (
							let s = u.expandedStates.length, D = s - 1;
							D >= 0;
							--D
						)
...
function J2(e) {
	...
	return e.type === x2
		...
		? {
				...
				expandedStates:
					(t8 = e.expandedStates) == null ? void 0 : t8.map(J2),
		  }
		: e.type === k2
...
var Dt2 = class extends w {
	...
	ct2 = class extends at2 {
		...
		validate(t8, r) {
			return (
				r.normalizeValidateResult(super.validate(t8, r), t8) === !0 &&
				Qr2(t8)
			);
		}
	},
				...
				(u.choices = e.choices.map((D) =>
					D != null && D.redirect
						? {
								...D,
								redirect: {
									to: { key: e.name, value: D.redirect },
								},
						  }
						: D,
				));
	...
	let t8 = e.type || e.kind || '(unknown type)',
		r = String(
			e.name ||
				...
				(e.value &&
					(typeof e.value == 'object' ? '' : String(e.value))) ||
				e.operator ||
				'',
		);
	return (
...
function Pn(e) {
	let { [Symbol.for('comments')]: t8, [Symbol.for('printedComments')]: r } =
		e;
	for (let n of t8) {
