	...
	if (!state.modifiersData[name]._skip) {
		for (
			var _options$mainAxis = options.mainAxis,
				...
				checkAltAxis =
					_options$altAxis === void 0 ? !0 : _options$altAxis,
		...
		if (makeFallbackChecks)
			for (
				var numberOfChecks = flipVariations ? 3 : 1,
					_loop = function (_i2) {
						var fittingPlacement = placements2.find(function (
							placement2,
						) {
				...
				var state2 = getLatest(),
					updatedState =
						typeof updater == 'function'
							? updater(state2)
							: updater;
				typeof updatedState.persist == 'function' &&
...
`,
	...
	WithToolTipState = ({
		...
		let [tooltipShown, setTooltipShown] = (0, import_react.useState)(
				startOpen,
			),
