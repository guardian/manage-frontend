	...
	'../../node_modules/get-intrinsic/index.js'(exports, module) {
		...
		var throwTypeError = function () {
			...
			INTRINSICS = {
				...
				'%Array%': Array,
				'%ArrayBuffer%':
					typeof ArrayBuffer > 'u' ? undefined2 : ArrayBuffer,
				...
				'%Int16Array%':
					typeof Int16Array > 'u' ? undefined2 : Int16Array,
				'%Int32Array%':
					typeof Int32Array > 'u' ? undefined2 : Int32Array,
				'%isFinite%': isFinite,
				'%isNaN%': isNaN,
				'%IteratorPrototype%':
					hasSymbols && getProto
				...
				'%TypeError%': $TypeError,
				'%Uint8Array%':
					typeof Uint8Array > 'u' ? undefined2 : Uint8Array,
				'%Uint8ClampedArray%':
					typeof Uint8ClampedArray > 'u'
						? undefined2
						: Uint8ClampedArray,
				'%Uint16Array%':
					typeof Uint16Array > 'u' ? undefined2 : Uint16Array,
				'%Uint32Array%':
					typeof Uint32Array > 'u' ? undefined2 : Uint32Array,
				'%URIError%': $URIError,
	...
	'../../node_modules/set-function-length/index.js'(exports, module) {
		...
		module.exports = function (fn, length) {
			...
			if ('length' in fn && gOPD) {
				...
				desc &&
					!desc.configurable &&
					(functionLengthIsConfigurable = !1),
...
` +
		...
		function arrObjKeys(obj, inspect) {
			...
			for (var key2 in obj)
				has3(obj, key2) &&
					((isArr &&
						String(Number(key2)) === key2 &&
						key2 < obj.length) ||
						(hasShammedSymbols &&
							symMap['$' + key2] instanceof Symbol) ||
						($test.call(/[^\w$]/, key2)
							? xs.push(
									inspect(key2, obj) +
										': ' +
		...
		var utils = require_utils(),
			...
			parseValues = function (str, options2) {
				var obj = { __proto__: null },
					cleanStr = options2.ignoreQueryPrefix
						? str.replace(/^\?/, '')
						: str,
					limit =
	...
	'../../node_modules/lodash/_isIndex.js'(exports, module) {
		...
		function isIndex(value2, length) {
			...
			return (
				...
				!!length &&
					(type == 'number' ||
						(type != 'symbol' && reIsUint.test(value2))) &&
					value2 > -1 &&
					value2 % 1 == 0 &&
					value2 < length
			);
...
var require_mergeWith = __commonJS({
	'../../node_modules/lodash/mergeWith.js'(exports, module) {
		var baseMerge = require_baseMerge(),
			...
			mergeWith2 = createAssigner(function (
				object,
				source2,
				srcIndex,
				customizer,
			...
			var _ = {
					...
					storeAPI: {
						...
						each: function (fn, fill) {
							for (
								var i = 0, m2 = _.length(this._area);
								i < m2;
								i++
							) {
						...
						transact: function (key2, fn, alt) {
							var val = this.get(key2, alt),
								ret = fn(val);
							return (
								this.set(key2, ret === void 0 ? val : ret), this
							);
						},
						...
						setAll: function (data, overwrite) {
							...
							for (var key2 in data)
								(val = data[key2]),
									this.set(key2, val, overwrite) !== val &&
										(changed = !0);
							return changed;
						},
					...
					storageAPI: {
						...
						removeItem: function (k2) {
							this.has(k2) &&
								(delete this.items[k2], this.length--);
						},
						getItem: function (k2) {
		...
		function equalObjects(
			...
			for (var index3 = objLength; index3--; ) {
				...
				if (
					!(isPartial
						? key2 in other
						: hasOwnProperty5.call(other, key2))
				)
					return !1;
			}
		...
		function baseMatches(source2) {
			...
			return matchData.length == 1 && matchData[0][2]
				...
				: function (object) {
						return (
							object === source2 ||
							baseIsMatch(object, source2, matchData)
						);
				  };
		}
...
var require_memoize = __commonJS({
	'../../node_modules/lodash/memoize.js'(exports, module) {
		...
		function memoize6(func, resolver) {
			...
			return (
				(memoized.cache = new (memoize6.Cache || MapCache2)()), memoized
			);
		}
	...
	'../../node_modules/lodash/_memoizeCapped.js'(exports, module) {
		...
		function memoizeCapped2(func) {
			var result2 = memoize6(func, function (key2) {
					return (
						cache.size === MAX_MEMOIZE_SIZE2 && cache.clear(), key2
					);
				}),
				cache = result2.cache;
			return result2;
	...
	require_isPlainObject = __commonJS2({
		'../../node_modules/lodash/isPlainObject.js'(exports, module) {
			...
			function isPlainObject2(value2) {
				...
				if (proto === null) return !0;
				var Ctor =
					hasOwnProperty5.call(proto, 'constructor') &&
					proto.constructor;
				return (
					typeof Ctor == 'function' &&
					Ctor instanceof Ctor &&
...
var splitPathRegex = /\/([^/]+)\/(?:(.*)_)?([^/]+)?/,
	...
	queryFromString = (0, import_memoizerific.default)(1e3)((s) =>
		s !== void 0
			? import_qs.default.parse(s, { ignoreQueryPrefix: !0 })
			: {},
	),
		...
		(current, target, startsWith = !0) => {
			if (startsWith) {
				if (typeof target != 'string')
					throw new Error(
						'startsWith only works with string targets',
					);
				return current && current.startsWith(target)
					? { path: current }
					: null;
			}
			let currentIsTarget =
...
function createBrowserHistory(options2) {
	...
	function allowTx(action2, location22, retry) {
		return (
			!blockers.length ||
			(blockers.call({ action: action2, location: location22, retry }),
			!1)
		);
	}
...
var Link = (0, import_react.forwardRef)(function (_ref3, ref) {
	...
	return (0,
	import_react.createElement)('a', _extends22({}, rest, { href, onClick: handleClick, ref, target }));
});
...
var events = ((events2) => (
		...
		(events2.UNHANDLED_ERRORS_WHILE_PLAYING =
		...
		(events2.FILE_COMPONENT_SEARCH_RESPONSE =
			...
			for (let key2 of __getOwnPropNames2(from))
				!__hasOwnProp2.call(to, key2) &&
					...
					__defProp2(to, key2, {
						get: () => from[key2],
						enumerable:
							!(desc = __getOwnPropDesc2(from, key2)) ||
							desc.enumerable,
					});
		return to;
	},
		...
		'node_modules/get-intrinsic/index.js'(exports, module) {
			...
			var throwTypeError = function () {
				...
				INTRINSICS = {
					...
					'%GeneratorFunction%': needsEval,
					'%Int8Array%':
						typeof Int8Array > 'u' ? undefined2 : Int8Array,
					'%Int16Array%':
						typeof Int16Array > 'u' ? undefined2 : Int16Array,
					'%Int32Array%':
						typeof Int32Array > 'u' ? undefined2 : Int32Array,
...
function isSymbol(value2) {
	return (
		typeof value2 == 'symbol' ||
		(isObjectLike_default(value2) &&
			baseGetTag_default(value2) == symbolTag)
	);
}
...
function hashSet(key2, value2) {
	...
	return (
		(this.size += this.has(key2) ? 0 : 1),
		(data[key2] =
			nativeCreate_default && value2 === void 0
				? HASH_UNDEFINED2
				: value2),
		this
	);
...
function convertUnconventionalData(data) {
	...
	return (
		...
		(result2 = Object.keys(result2).reduce((acc, key2) => {
			try {
				result2[key2] && result2[key2].toJSON,
			...
			isObject3(value2) &&
				Object.entries(value2).forEach(([k2, v]) => {
					v === '_undefined_'
						? (value2[k2] = void 0)
						: mutated.get(v) ||
						  (mutated.set(v, !0), mutateUndefined(v));
				}),
				Array.isArray(value2) &&
			...
			try {
				...
				if (key2 === KEY) {
					let pageString =
						...
						eventString = Object.values(dist_exports2).includes(
							event.type,
						)
...
var React33 = __toESM(require_react(), 1),
	...
	PhotoIcon = React33.forwardRef(
		(
			{ color: color2 = 'currentColor', size = 14, ...props },
			forwardedRef,
		) =>
			...
			for (let key2 of __getOwnPropNames3(from))
				!__hasOwnProp3.call(to, key2) &&
					...
					__defProp3(to, key2, {
						get: () => from[key2],
						enumerable:
							!(desc = __getOwnPropDesc3(from, key2)) ||
							desc.enumerable,
					});
		return to;
	},
	...
	require_re = __commonJS4({
		'../../node_modules/semver/internal/re.js'(exports, module) {
			...
			var re = (exports.re = []),
				...
				createToken = (name2, value2, isGlobal) => {
					...
					debug(name2, index3, value2),
						(t[name2] = index3),
						(src[index3] = value2),
						(re[index3] = new RegExp(
							value2,
							isGlobal ? 'g' : void 0,
						)),
						(safeRe[index3] = new RegExp(
							safe,
							isGlobal ? 'g' : void 0,
						));
				};
			createToken('NUMERICIDENTIFIER', '0|[1-9]\\d*'),
				...
				createToken(
					'FULLPLAIN',
					`v?${src[t.MAINVERSION]}${src[t.PRERELEASE]}?${
						src[t.BUILD]
					}?`,
				),
				...
				createToken(
					'XRANGE',
					`^${src[t.GTLT]}\\s*${src[t.XRANGEPLAIN]}$`,
				),
				createToken(
					'XRANGELOOSE',
				...
				createToken(
					'TILDE',
					`^${src[t.LONETILDE]}${src[t.XRANGEPLAIN]}$`,
				),
				createToken(
					'TILDELOOSE',
				...
				createToken(
					'CARET',
					`^${src[t.LONECARET]}${src[t.XRANGEPLAIN]}$`,
				),
				createToken(
					'CARETLOOSE',
			...
			var SemVer = require_semver(),
				...
				coerce = (version2, options2) => {
					...
					let major = match[2],
						...
						patch = match[4] || '0',
						prerelease =
							options2.includePrerelease && match[5]
								? `-${match[5]}`
								: '',
						build =
							options2.includePrerelease && match[6]
								? `+${match[6]}`
								: '';
					return parse22(
		...
		'../../node_modules/yallist/yallist.js'(exports, module) {
			...
			(Yallist.prototype.removeNode = function (node) {
				...
				(Yallist.prototype.map = function (fn, thisp) {
					thisp = thisp || this;
					for (
						var res = new Yallist(), walker = this.head;
						walker !== null;
				...
				(Yallist.prototype.mapReverse = function (fn, thisp) {
					thisp = thisp || this;
					for (
						var res = new Yallist(), walker = this.tail;
						walker !== null;
			...
			function Node(value2, prev, next, list) {
				...
				(this.list = list),
					(this.value = value2),
					prev
						? ((prev.next = this), (this.prev = prev))
						: (this.prev = null),
					next
						? ((next.prev = this), (this.next = next))
						: (this.next = null);
			}
			try {
			...
			var Yallist = require_yallist(),
				...
				LRUCache = class {
					constructor(options2) {
						if (
							(typeof options2 == 'number' &&
								(options2 = { max: options2 }),
							options2 || (options2 = {}),
							options2.max &&
								(typeof options2.max != 'number' ||
									options2.max < 0))
						)
							throw new TypeError(
			...
			var LRU = require_lru_cache(),
				...
				isSatisfiable = (comparators, options2) => {
					...
					for (; result2 && remainingComparators.length; )
						(result2 = remainingComparators.every(
							(otherComparator) =>
				...
				replaceGTE0 = (comp, options2) => (
					...
					comp
						.trim()
						.replace(
							re[options2.includePrerelease ? t.GTE0PRE : t.GTE0],
							'',
						)
				),
				hyphenReplace =
				...
				Comparator = class _Comparator {
					...
					intersects(comp, options2) {
						...
						return this.operator === ''
							? this.value === ''
								? !0
								: new Range(comp.value, options2).test(
										this.value,
								  )
							: comp.operator === ''
							? comp.value === ''
								? !0
								: new Range(this.value, options2).test(
										comp.semver,
								  )
							: ((options2 = parseOptions(options2)),
							  (options2.includePrerelease &&
...
var TITLE_PATH_SEPARATOR = /\s*\/\s*/,
	...
	transformStoryIndexToStoriesHash = (
		...
		(index3 = index3.v === 2 ? transformStoryIndexV2toV3(index3) : index3),
			(index3 =
				index3.v === 3 ? transformStoryIndexV3toV4(index3) : index3),
			(index3 =
				index3.v === 4 ? transformStoryIndexV4toV5(index3) : index3),
			(index3 = index3);
	...
	getStoriesLookupList = (0, import_memoizerific3.default)(1)((hash) =>
		Object.keys(hash).filter((k2) =>
			['story', 'docs'].includes(hash[k2].type),
		),
	),
...
var init7 = ({
		...
		let api = {
			...
			getCurrentParameter: (parameterName) => {
				let { storyId, refId } = store2.getState();
				return (
					api.getParameters({ storyId, refId }, parameterName) ||
					void 0
				);
			},
			jumpToComponent: (direction) => {
				...
				if (!hash) return;
				let result2 = api.findSiblingStoryId(
					storyId,
					hash,
					direction,
					!0,
			...
			findSiblingStoryId(storyId, index3, direction, toSiblingGroup) {
				if (toSiblingGroup) {
					let lookupList2 = getComponentLookupList(index3),
						position2 = lookupList2.findIndex((i) =>
							i.includes(storyId),
						);
			...
			experimental_updateStatus: async (id, input) => {
				let { status, internal_index: index3 } = store2.getState(),
					newStatus = { ...status },
					update2 =
						typeof input == 'function' ? input(status) : input;
				if (
		...
		provider.channel?.on(STORY_SPECIFIED, function ({ storyId, viewMode }) {
			...
			provider.channel?.on(SET_INDEX, function (index3) {
				let { ref } = getEventMetadata(this, fullAPI);
				if (ref)
					fullAPI.setRef(ref.id, { ...ref, storyIndex: index3 }, !0);
				else {
					api.setIndex(index3);
					let options2 = api.getCurrentParameter('options');
					fullAPI.setOptions(removeRemovedOptions(options2));
...
var { document: document3 } = scope,
	...
	getIsPanelShown = (state) => {
		let { bottomPanelHeight, rightPanelWidth, panelPosition } =
			state.layout;
		return (
	...
	getIsFullscreen = (state) =>
		!getIsNavShown(state) && !getIsPanelShown(state),
	...
	init8 = ({ store: store2, provider, singleStory }) => {
		let api = {
										...
										layout: {
											...
											navSize: state.singleStory
												...
												: state.layout
														...
														.navSize,
											bottomPanelHeight:
												state.layout.recentVisibleSizes
													.bottomPanelHeight,
											rightPanelWidth:
												state.layout.recentVisibleSizes
													.rightPanelWidth,
						...
						(state) => {
							...
							return {
								layout: {
									...nextLayoutState,
									recentVisibleSizes:
										getRecentVisibleSizes(nextLayoutState),
								},
							};
						},
						{ persistence: 'session' },
				...
				getInitialOptions() {
					let { theme, selectedPanel, ...options2 } =
						provider.getConfig();
					return {
						...defaultLayoutState,
						layout: {
						...
						selectedPanel:
							selectedPanel || defaultLayoutState.selectedPanel,
				...
				setOptions: (options2) => {
					let { layout, ui, selectedPanel, theme } =
						store2.getState();
					if (!options2) return;
					let updatedLayout = {
							...layout,
		...
		let api = {
				...
				async setAddonShortcut(addon, shortcut) {
					...
					return (
						await api.setShortcuts({
							...shortcuts,
							[`${addon}-${shortcut.actionName}`]:
								shortcut.defaultShortcut,
						}),
						(addonsShortcuts[`${addon}-${shortcut.actionName}`] =
							shortcut),
						shortcut
					);
				},
					...
					if (enableShortcuts)
						switch (
							...
							case 'focusPanel': {
								fullAPI.getIsFullscreen() &&
									fullAPI.toggleFullscreen(!1),
									fullAPI.getIsPanelShown() ||
										fullAPI.togglePanel(!0),
									fullAPI.focusOnUIElement(
...
var { window: globalWindow } = scope,
	...
	initialUrlSupport = ({
		...
		let layout = {
				...
				bottomPanelHeight,
				rightPanelWidth,
				panelPosition: ['right', 'bottom'].includes(panel)
					? panel
					: void 0,
			...
			api = {
				...
				getLatestVersion: () => {
					...
					return current &&
						...
						next
						? latest &&
						  import_semver.default.gt(latest.version, next.version)
							? latest
							: next
						: latest;
				},
				getDocsUrl: ({ subpath, versioned, renderer }) => {
					...
					if (versioned && current?.version && latest?.version) {
						...
						versionDiff === 'patch' ||
							versionDiff === null ||
							(url += `${import_semver.default.major(
								current.version,
					...
					if (
						...
						rendererName &&
							(url += `?renderer=${normalizeRendererName(
								rendererName,
							)}`);
					}
					return url;
...
var AddonStore = class {
		constructor() {
			(this.loaders = {}),
				...
				(this.loadAddons = (api) => {
					Object.values(this.loaders).forEach((value2) =>
						value2(api),
					);
				}),
	...
	ManagerProvider = class extends import_react2.Component {
		constructor(props) {
			...
			let {
					...
					path,
					refId,
					viewMode = props.docsOptions.docsMode
						? 'docs'
						: props.viewMode,
					singleStory,
					storyId,
	...
	return (
		$9f79659886946c16$export$e5c5a5f917a5871c(() => {
			deterministicId ||
				setId(
					(reactId) =>
						reactId ?? String($1746a345f3d73bb7$var$count++),
				);
		}, [deterministicId]),
		...
		(0, import_react5.useMemo)(
			() =>
				(...args2) => {
					...
					return (_callbackRef$current = callbackRef.current) ===
						null || _callbackRef$current === void 0
						? void 0
	...
	$5cb92bef7577960e$export$177fb62ff3ec1f22 = (0, import_react9.forwardRef)(
		(props, forwardedRef) => {
			...
			let {
				...
				pointerDownOutside =
					$5cb92bef7577960e$var$usePointerDownOutside((event) => {
						let target = event.target,
							isPointerDownOnBranch = [...context.branches].some(
				...
				focusOutside = $5cb92bef7577960e$var$useFocusOutside(
					(event) => {
						let target = event.target;
...
function $d3863c46a17e8a28$var$getTabbableEdges(container) {
	let candidates = $d3863c46a17e8a28$var$getTabbableCandidates(container),
		...
		last = $d3863c46a17e8a28$var$findVisible(
			candidates.reverse(),
			container,
		);
	return [first, last];
...
var $921a889cee6df7e8$export$99c2b779aa4e8b8b = (props) => {
	let { present, children } = props,
		...
		ref = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(
			presence.ref,
			child.ref,
		);
...
function $921a889cee6df7e8$var$usePresence(present) {
	let [node1, setNode] = (0, import_react12.useState)(),
		...
		[state, send] = $fe963b355347cc68$export$3e6543de14f8614f(
			initialState,
			{
				mounted: {
					UNMOUNT: 'unmounted',
	...
	return (
		...
		}, [node1, send]),
		{
			...
			ref: (0, import_react12.useCallback)((node) => {
				node && (stylesRef.current = getComputedStyle(node)),
					setNode(node);
			}, []),
		}
	);
...
function $3db38b7d1fb3fe6a$export$b7ece24a22aeda8c() {
	(0, import_react13.useEffect)(() => {
		...
		return (
			...
			document.body.insertAdjacentElement(
				'beforeend',
				(_edgeGuards$2 = edgeGuards[1]) !== null &&
					_edgeGuards$2 !== void 0
					? _edgeGuards$2
					: $3db38b7d1fb3fe6a$var$createFocusGuard(),
			),
		...
		return {
			...
			facade: {
				...
				set current(value2) {
					var last = ref.value;
					last !== value2 &&
						((ref.value = value2), ref.callback(value2, last));
				},
			},
		};
	})[0];
...
function createSidecarMedium(options2) {
	...
	return (
		(medium.options = __assign({ async: !0, ssr: !1 }, options2)), medium
	);
}
...
function RemoveScrollSideCar(props) {
	...
	var shouldCancelEvent = React8.useCallback(function (event, parent) {
		...
		shouldPrevent = React8.useCallback(function (_event) {
			...
			if (
				!(
					!lockStack.length ||
					lockStack[lockStack.length - 1] !== Style2
				)
			) {
				var delta =
						'deltaY' in event
		...
		shouldCancel = React8.useCallback(function (
			name2,
			delta,
			target,
			should,
	...
	return React8.createElement(
		...
		null,
		inert
			? React8.createElement(Style2, { styles: generateStyle(id) })
			: null,
		removeScrollBar
	...
	hideOthers = function (originalTarget, parentNode, markerName) {
		...
		return activeParentNode
			? (targets.push.apply(
					targets,
					Array.from(
						activeParentNode.querySelectorAll('[aria-live]'),
					),
			  ),
		...
		return (0, import_react15.createElement)(
			...
			_extends2({}, props, {
				...
				onCloseAutoFocus: (event) => {
					...
					if (
						((_props$onCloseAutoFoc = props.onCloseAutoFocus) ===
							null ||
				...
				onInteractOutside: (event) => {
					...
					(_props$onInteractOuts = props.onInteractOutside) ===
						null ||
					...
					let target = event.target;
					((_context$triggerRef$c3 = context.triggerRef.current) ===
						null || _context$triggerRef$c3 === void 0
						? void 0
	...
	$5d3850c4d0b4e6c7$export$16f7638e4a34b909 = (0, import_react15.forwardRef)(
		(props, forwardedRef) => {
			...
			return (0, import_react15.createElement)(
				...
				_extends2({ id: context.titleId }, titleProps, {
					ref: forwardedRef,
				}),
			);
		},
...
var curriedTransparentize = curry(transparentize),
	...
	UL = newStyled.ul(withReset, withMargin, listCommon2, {
		listStyle: 'disc',
	}),
...
var Button = (0, import_react16.forwardRef)(
	(
		...
		let localVariant = variant,
			...
			handleClick = (event) => {
				onClick && onClick(event),
					animation !== 'none' && setIsAnimating(!0);
			};
		if (
...
function useResizeObserver(opts) {
	...
	var round = opts.round || Math.round,
		...
		_useState = (0, import_react16.useState)({
			width: void 0,
			height: void 0,
		}),
		size = _useState[0],
	...
	var previous = (0, import_react16.useRef)({
			width: void 0,
			height: void 0,
		}),
...
var ZoomIFrame = class extends import_react16.Component {
	...
	ErrorName = newStyled.strong(({ theme }) => ({
	...
	ErrorDetail = newStyled.em(({ theme }) => ({
...
var useWindowResizeListener = function (listener) {
	...
	Textarea = Object.assign(
		newStyled(
			(0, import_react16.forwardRef)(function (
				...
				return import_react16.default.createElement(index2, {
					...props,
					ref,
				});
			}),
	...
	WithTooltipPure = (props) =>
		import_react16.default.createElement(
			import_react16.Suspense,
			{ fallback: import_react16.default.createElement('div', null) },
			import_react16.default.createElement(LazyWithTooltipPure, {
				...props,
			}),
		),
	...
	TooltipMessage = ({ title, desc, links }) =>
		import_react16.default.createElement(
			...
			import_react16.default.createElement(
				...
				null,
				title &&
					import_react16.default.createElement(Title4, null, title),
	...
	ListItem = ({
		loading = !1,
		title = import_react16.default.createElement(
			'span',
			null,
			'Loading state',
		),
...
var VisuallyHidden = newStyled.div(({ active }) =>
    ...
    .addon-collapsible-icon {
      color: ${
			preActive || active ? theme.barSelectedColor : theme.barTextColor
		};
    }
    &:hover {
      color: ${theme.barHoverColor};
	...
	let tabBarRef = (0, import_react16.useRef)(),
		...
		AddonTab = (0, import_react16.useCallback)(
			({ menuName, actions }) => {
				let isAddonsActive = invisibleList.some(({ active }) => active),
					[isTooltipVisible, setTooltipVisible] = (0,
					import_react16.useState)(!1);
				return import_react16.default.createElement(
					import_react16.default.Fragment,
					null,
					import_react16.default.createElement(
						WithToolTipState,
						{
							...
							placement: 'bottom',
							delayHide: 100,
							tooltip: import_react16.default.createElement(
								TooltipLinkList,
								{
						...
						import_react16.default.createElement(
							AddonButton,
							{
								...
								style: {
									visibility: invisibleList.length
										? 'visible'
										: 'hidden',
								},
							...
							import_react16.default.createElement(
								CollapseIcon2,
								{
									...
									isActive:
										isAddonsActive || isTooltipVisible,
								},
							),
						),
					),
					invisibleList.map(
						({ title, id, color: color2 }, index3) => {
		...
		setTabLists = (0, import_react16.useCallback)(() => {
			...
			let { x: x2, width } = tabBarRef.current.getBoundingClientRect(),
				{ width: widthAddonsTab } =
					addonsRef.current.getBoundingClientRect(),
...
`,
	...
	StorybookLogo = ({ alt, ...props }) =>
		import_react16.default.createElement(
			...
			alt
				? import_react16.default.createElement('title', null, alt)
				: null,
			import_react16.default.createElement(
				'defs',
				null,
			...
			return (
				...
				import_react16.default.createElement(
					...
					import_react16.default.createElement(
						...
						message,
						value2 < 1 &&
							import_react16.default.createElement(Ellipsis, {
								key: message,
							}),
					),
				)
