	...
	'../../node_modules/lodash/throttle.js'(exports, module) {
		...
		function throttle2(func, wait, options2) {
			...
			return (
				isObject(options2) &&
					((leading =
						'leading' in options2 ? !!options2.leading : leading),
					(trailing =
						'trailing' in options2
							? !!options2.trailing
							: trailing)),
		...
		(function (e3, t3) {
			...
			return (function (e3) {
				...
				function r3(n3) {
					...
					return (
						e3[n3].call(o3.exports, o3, o3.exports, r3),
						(o3.l = !0),
						o3.exports
					);
				}
									...
									},
									{
										...
										value: function (e5) {
											if (
												...
												for (
													var t5 = 0, r5 = e5.length;
													t5 < r5;
													t5 += 1
												) {
													var n4 = e5[t5];
													(this._keyWeights[n4] = 1),
														this._keyNames.push(n4);
												}
											else {
												for (
													var o4 = null,
			...
			try {
				...
				try {
					window.clipboardData.setData(
						options2.format || 'text',
						text,
					),
						options2.onCopy &&
							options2.onCopy(window.clipboardData),
						(success = !0);
				} catch (err2) {
					debug &&
						console.error(
		...
		(a =
			...
			function (t3) {
				for (var e3 = 1; e3 < arguments.length; e3++) {
					var r3 = arguments[e3];
					for (var n3 in r3)
						Object.prototype.hasOwnProperty.call(r3, n3) &&
							(t3[n3] = r3[n3]);
				}
				return t3;
			}),
	...
	A = function (t3, e3) {
		return e3
			...
			.reduce(function (e4, r3) {
				if (!e4.length)
					for (
						var n3 = Object.keys(r3), i2 = 0;
						i2 < n3.length;
						i2 += 1
					) {
						var o3 = n3[i2].toLowerCase();
						if (t3.indexOf(o3) !== -1 && r3[o3])
							return e4.concat(r3);
					}
				return e4;
			}, []);
			...
			.reduce(function (t4, r4) {
				...
				r4.filter(function (t5) {
					for (
						...
						e3.indexOf(c3) === -1 ||
							(r5 === 'rel' &&
								t5[r5].toLowerCase() === 'canonical') ||
							(c3 === 'rel' &&
								t5[c3].toLowerCase() === 'stylesheet') ||
							(r5 = c3),
							e3.indexOf(s3) === -1 ||
								(s3 !== 'innerHTML' &&
									s3 !== 'cssText' &&
			...
			? t3.reduce(
					function (t4, r3) {
						return (
							(function (t5, e4) {
								for (
									var r4 = Object.keys(t5), n3 = 0;
									n3 < r4.length;
									n3 += 1
								)
									if (
										e4[r4[n3]] &&
										e4[r4[n3]].includes(t5[r4[n3]])
									)
										return !0;
								return !1;
							})(r3, e3)
...
var Y = function (t3, e3) {
						...
						Object.prototype.hasOwnProperty.call(e4, i3) &&
							(i3 === 'innerHTML'
								...
								? n4.styleSheet
									...
									: n4.appendChild(
											document.createTextNode(e4.cssText),
									  )
								: n4.setAttribute(
										i3,
										e4[i3] === void 0 ? '' : e4[i3],
	...
	B = function (t3, e3) {
		...
		if (r3) {
			...
			for (var p2 = o3.length - 1; p2 >= 0; p2 -= 1)
				r3.removeAttribute(o3[p2]);
			i2.length === o3.length
	...
	z = (function (t3) {
		function e3() {
			for (
				...
				n3[i2] = arguments[i2];
			return (
				((e4 = t3.call.apply(t3, [this].concat(n3)) || this).rendered =
					!1),
				e4
			);
		}
		...
		return (
			...
			(o3.render = function () {
				...
				return (
					...
					!o4 ||
						o4 instanceof N ||
						(o4 = new N(o4.context, o4.instances)),
					o4
						? import_react.default.createElement(
								z,
								a({}, i2, {
...
var LayoutContext = (0, import_react4.createContext)({
	...
	LayoutProvider = ({ children }) => {
		let [isMobileMenuOpen, setMobileMenuOpen] = (0, import_react4.useState)(
				!1,
			),
			[isMobileAboutOpen, setMobileAboutOpen] = (0,
			import_react4.useState)(!1),
			[isMobilePanelOpen, setMobilePanelOpen] = (0,
			import_react4.useState)(!1),
...
var SidebarIconButton = newStyled(IconButton)(({ highlighted, theme }) => ({
		...
		...(highlighted && {
			...
			'&:hover:after, &:focus-visible:after': {
				boxShadow: `0 0 0 2px ${curriedTransparentize$1(
					0.88,
	...
	SidebarMenu = ({ menu, isHighlighted, onClick }) => {
		let [isTooltipVisible, setIsTooltipVisible] = (0,
			import_react5.useState)(!1),
		...
		import_react6.default.createElement(
			...
			isLoading
				...
				: extra.map(({ id, render: Render }) =>
						import_react6.default.createElement(Render, {
							key: id,
						}),
				  ),
	...
	Loader2 = ({ size }) => {
		...
		return import_react7.default.createElement(
			...
			sequence.map((depth, index) =>
				import_react7.default.createElement(Loadingitem, {
					depth,
					key: index,
				}),
			),
...
var { window: globalWindow } = scope,
	...
	AuthBlock = ({ loginUrl, id }) => {
		let [isAuthAttempted, setAuthAttempted] = (0, import_react8.useState)(
				!1,
			),
	...
	LoaderBlock = ({ isMain }) =>
		import_react8.default.createElement(
			Contained,
			null,
			import_react8.default.createElement(Loader2, {
				size: isMain ? 17 : 5,
			}),
		);
	...
	GroupNode = import_react12.default.memo(function ({
		...
		return import_react12.default.createElement(
			...
			import_react12.default.createElement(
				...
				null,
				isExpandable &&
					import_react12.default.createElement(CollapseIcon2, {
						isExpanded,
					}),
				import_react12.default.createElement(
					TypeIcon,
...
var codeToKeyMap = {
	...
	matchesModifiers = (modifiers, event) => {
		let { alt, ctrl, meta, shift } =
			modifiers === !1 ? allFalse : modifiers;
		return !(
...
var { document: document3, window: globalWindow3 } = scope,
	...
	getLink = (item, refId) =>
		`${document3.location.pathname}?path=/${item.type}/${createId(
			item.id,
			refId,
		)}`;
...
var { document: document4 } = scope,
	...
	useExpanded = ({
		...
		return (
			...
			(0, import_react13.useEffect)(() => {
				let menuElement = document4.getElementById(
					...
					navigateTree = (0, import_throttle.default)((event) => {
						...
						if (
							!(isEnter || isSpace || isArrowLeft || isArrowRight)
						)
							return;
						...
						if (
							!highlightedElement ||
							highlightedElement.getAttribute('data-ref-id') !==
								refId
						)
							return;
						...
						if (isArrowLeft) {
							...
							let parentId =
								...
								parentElement =
									parentId &&
									getElementByDataItemId(parentId);
							if (
								parentElement &&
...
var Container = newStyled.div((props) => ({
	...
	Node2 = import_react15.default.memo(function ({
		...
		if (item.type === 'root')
			return import_react15.default.createElement(
				...
				import_react15.default.createElement(
					...
					import_react15.default.createElement(CollapseIcon2, {
						isExpanded,
					}),
					item.renderLabel?.(item, api) || item.name,
				),
		...
		if (item.type === 'component' || item.type === 'group') {
			let BranchNode2 =
				item.type === 'component' ? ComponentNode : GroupNode;
			return import_react15.default.createElement(
				BranchNode2,
				{
					key: id,
					...
					'data-parent-id': item.parent,
					'data-nodetype':
						item.type === 'component' ? 'component' : 'group',
					'data-highlightable': isDisplayed,
			...
			{ expandableDescendants } = (0, import_react15.useMemo)(
				() =>
					[...orphanIds, ...rootIds].reduce(
						(acc, nodeId) => (
							(acc.expandableDescendants[nodeId] =
			...
			treeItems = (0, import_react15.useMemo)(
				() =>
					collapsedItems.map((itemId) => {
						...
						let isDisplayed =
								!item.parent ||
								ancestry[itemId].every((a2) => expanded[a2]),
		...
		return import_react16.default.createElement(
			...
			isExpanded &&
				import_react16.default.createElement(
					...
					state === 'loading' &&
						import_react16.default.createElement(LoaderBlock, {
							isMain,
						}),
					state === 'empty' &&
						import_react16.default.createElement(EmptyBlock, {
							isMain,
						}),
					state === 'ready' &&
...
var { document: document5, window: globalWindow4 } = scope,
	...
	useHighlighted = ({
		...
		return (
			...
			(0, import_react17.useEffect)(() => {
				let menuElement = document5.getElementById(
						'storybook-explorer-menu',
					),
					lastRequestId,
					navigateTree = (event) => {
						...
						let requestId = globalWindow4.requestAnimationFrame(
							() => {
								globalWindow4.cancelAnimationFrame(
									lastRequestId,
								),
...
var Explorer = import_react19.default.memo(function ({
	...
	return import_react19.default.createElement(
		...
		highlighted &&
			import_react19.default.createElement(HighlightStyles, {
				...highlighted,
			}),
...
var t2 = (t3) => typeof t3 == 'object' && t3 != null && t3.nodeType === 1,
	...
	n2 = (t3, n3) => {
		if (
			t3.clientHeight < t3.scrollHeight ||
			t3.clientWidth < t3.scrollWidth
		) {
	...
	r2 = (e3, r3) => {
		...
		let b2 =
				(s2 =
					(i2 = window.visualViewport) == null ? void 0 : i2.width) !=
				null
					? s2
					: innerWidth,
			H2 =
				(h2 =
					(d2 = window.visualViewport) == null
						? void 0
						: d2.height) != null
					? h2
					: innerHeight,
		...
		for (let t3 = 0; t3 < w2.length; t3++) {
			...
			let h3 = getComputedStyle(e4),
				...
				F3 =
					'offsetWidth' in e4
						? e4.offsetWidth - e4.clientWidth - a3 - p3
						: 0,
				V2 =
					'offsetHeight' in e4
		...
		var Downshift2 = (function (_Component) {
			function Downshift3(_props) {
				...
				(_this = _Component.call(this, _props) || this),
					...
					(_this.labelId =
						_this.props.labelId || _this.id + '-label'),
					(_this.inputId =
						_this.props.inputId || _this.id + '-input'),
					(_this.getItemId =
					...
					(_this.internalSetTimeout = function (fn, time) {
						var id = setTimeout(function () {
							(_this.timeoutIds = _this.timeoutIds.filter(
								function (i2) {
									return i2 !== id;
								},
							)),
					...
					(_this.isItemDisabled = function (_item, index) {
						var currentElementNode =
							_this.getItemNodeFromIndex(index);
						return (
							currentElementNode &&
							currentElementNode.hasAttribute('disabled')
						);
					}),
							...
							_this.setState(
								...
								function () {
									...
									var hasMoreStateThanType =
										Object.keys(onStateChangeArg).length >
										1;
					...
					(_this.getRootProps = function (_temp, _temp2) {
						var _extends2,
							...
							refKey =
								_ref$refKey === void 0 ? 'ref' : _ref$refKey,
							ref = _ref.ref,
							...
							suppressRefError =
								_ref2$suppressRefErro === void 0
									? !1
									: _ref2$suppressRefErro;
						(_this.getRootProps.called = !0),
							(_this.getRootProps.refKey = refKey),
							(_this.getRootProps.suppressRefError =
								suppressRefError);
					...
					(_this.keyDownHandlers = {
						ArrowDown: function (event) {
							var _this2 = this;
							if (
								(event.preventDefault(), this.getState().isOpen)
							) {
						...
						Enter: function (event) {
							if (event.which !== 229) {
								var _this$getState2 = this.getState(),
									...
									highlightedIndex =
										_this$getState2.highlightedIndex;
								if (isOpen && highlightedIndex != null) {
									...
									if (
										item == null ||
										(itemNode &&
											itemNode.hasAttribute('disabled'))
									)
										return;
					...
					(_this.buttonHandleBlur = function (event) {
						...
						_this.internalSetTimeout(function () {
							if (
								!(_this.isMouseDown || !_this.props.environment)
							) {
								var activeElement =
									_this.props.environment.document
										.activeElement;
								(activeElement == null ||
									activeElement.id !== _this.inputId) &&
					...
					(_this.getInputProps = function (_temp4) {
						...
						if (!rest.disabled) {
							...
							eventHandlers =
								((_eventHandlers = {}),
								(_eventHandlers[onChangeKey] =
									callAllEventHandlers(
										onChange,
										onInput,
										_this.inputHandleChange,
									)),
								(_eventHandlers.onKeyDown =
									callAllEventHandlers(
										onKeyDown,
							...
							if (
								...
								var activeElement =
									...
									downshiftButtonIsActive =
										(activeElement == null ||
										(_activeElement$datase =
											activeElement.dataset) == null
											? void 0
					...
					(_this.getMenuProps = function (_temp5, _temp6) {
						var _extends3,
							...
							refKey =
								_ref5$refKey === void 0 ? 'ref' : _ref5$refKey,
							ref = _ref5.ref,
							...
							suppressRefError =
								_ref6$suppressRefErro === void 0
									? !1
									: _ref6$suppressRefErro;
						return (
							(_this.getMenuProps.called = !0),
							(_this.getMenuProps.refKey = refKey),
							(_this.getMenuProps.suppressRefError =
								suppressRefError),
							_extends(
								((_extends3 = {}),
					...
					(_this.getItemProps = function (_temp7) {
						...
						var onSelectKey = 'onClick',
							...
							enabledEventHandlers =
								...
								(_enabledEventHandlers[onSelectKey] =
									callAllEventHandlers(
										customClickHandler,
										function () {
							...
							eventHandlers = rest.disabled
								? {
										onMouseDown:
											enabledEventHandlers.onMouseDown,
								  }
								: enabledEventHandlers;
						return _extends(
							{
							...
							_this.internalSetState(
								...
								function () {
									var _this$getState7 = _this.getState(),
										...
										highlightedIndex =
											_this$getState7.highlightedIndex;
									isOpen &&
				...
				var _this$props2 = _this.props,
					defaultHighlightedIndex =
						_this$props2.defaultHighlightedIndex,
					_this$props2$initialH =
						_this$props2.initialHighlightedIndex,
					_highlightedIndex =
					...
					_inputValue =
						_this$props2$initialI2 === void 0
							? ''
							: _this$props2$initialI2,
					_this$props2$initialS = _this$props2.initialSelectedItem,
					_selectedItem =
						_this$props2$initialS === void 0
							? null
							: _this$props2$initialS,
			...
			return (
				...
				(_proto.moveHighlightedIndex = function (
					amount,
					otherStateToSet,
				) {
					var itemCount = this.getItemCount(),
				...
				(_proto.shouldScroll = function (prevState, prevProps) {
					var _ref10 =
						...
						_ref11 =
							prevProps.highlightedIndex === void 0
								? prevState
								: prevProps,
	...
	return (
		(0, import_react20.useEffect)(
			function () {
				...
				var downshiftElements = downshiftElementRefs.map(function (
					ref,
				) {
					return ref.current;
				});
	...
	var toggleButtonKeyDownHandlers = (0, import_react20.useMemo)(
			function () {
				return {
					...
					Home: function (event) {
						event.preventDefault(),
							dispatch({ type: ToggleButtonKeyDownHome });
					},
					End: function (event) {
						event.preventDefault(),
							dispatch({ type: ToggleButtonKeyDownEnd });
					},
					Escape: function () {
						latest.current.state.isOpen &&
		...
		getLabelProps = (0, import_react20.useCallback)(
			function (_temp) {
				var _ref = _temp === void 0 ? {} : _temp,
					...
					labelProps = _objectWithoutPropertiesLoose(
						_ref,
						_excluded$2,
					),
					labelHandleClick = function () {
						var _toggleButtonRef$curr;
						(_toggleButtonRef$curr = toggleButtonRef.current) ==
							null || _toggleButtonRef$curr.focus();
					};
				return _extends(
					{
		...
		getMenuProps = (0, import_react20.useCallback)(
			function (_temp2, _temp3) {
				var _extends2,
					...
					suppressRefError =
						_ref3$suppressRefErro === void 0
							? !1
							: _ref3$suppressRefErro,
		...
		getToggleButtonProps = (0, import_react20.useCallback)(
			function (_temp4, _temp5) {
				...
				var onKeyDown = _ref4.onKeyDown,
					...
					suppressRefError =
						_ref5$suppressRefErro === void 0
							? !1
							: _ref5$suppressRefErro,
		...
		getInputProps = (0, import_react20.useCallback)(
			function (_temp5, _temp6) {
				...
				var onClick = _ref6.onClick,
					...
					suppressRefError =
						_ref7$suppressRefErro === void 0
							? !1
							: _ref7$suppressRefErro;
				setGetterPropCallInfo(
					'getInputProps',
					suppressRefError,
					refKey,
		...
		getSelectedItemProps = (0, import_react20.useCallback)(
			function (_temp) {
				var _extends2,
					...
					index = _getItemAndIndex[1],
					isFocusable =
						index > -1 && index === latestState.activeIndex,
		...
		getDropdownProps = (0, import_react20.useCallback)(
			function (_temp2, _temp3) {
				var _extends3,
					...
					preventKeyAction =
						_ref4$preventKeyActio === void 0
							? !1
							: _ref4$preventKeyActio,
...
function useDebounce(value, delay) {
	let [debouncedValue, setDebouncedValue] = (0, import_react21.useState)(
		value,
	);
	return (
...
function setArgType(type, obj, objKey) {
	if (!(typeof type == 'string' || !type.required))
		switch (type.name) {
			...
			case 'object':
				(obj[objKey] = {}),
					Object.entries(type.value ?? {}).forEach(
						([typeKey, typeVal]) => {
...
var FileListWrapper = newStyled('div')(({ theme }) => ({
		...
		'&::after': {
			...
			right: 0,
			height: '80px',
			background: `linear-gradient(${rgba(theme.barBg, 0)} 10%, ${
				theme.barBg
			} 80%)`,
		},
	})),
	...
	FileListExport = newStyled('ul')(({ theme }) => ({
		margin: 0,
		padding: 0,
	})),
		...
		constructor(opts) {
			(this.unsubs = []),
				...
				(this.getFurthestMeasurement = (measurements, index) => {
					...
					for (let m2 = index - 1; m2 >= 0; m2--) {
						...
						if (furthestMeasurementsFound.has(measurement.lane))
							continue;
						let previousFurthestMeasurement =
							furthestMeasurements.get(measurement.lane);
						if (
							(previousFurthestMeasurement == null ||
							measurement.end > previousFurthestMeasurement.end
								? furthestMeasurements.set(
										measurement.lane,
										measurement,
								  )
								: measurement.end <
										previousFurthestMeasurement.end &&
								  furthestMeasurementsFound.set(
										measurement.lane,
										!0,
								  ),
							furthestMeasurementsFound.size ===
								this.options.lanes)
						)
							break;
					}
				...
				(this._measureElement = (node, entry) => {
					let item =
						this.measurementsCache[this.indexFromElement(node)];
					...
					let measuredItemSize = this.options.measureElement(
						node,
						entry,
						this,
					);
				...
				(this.resizeItem = (item, size) => {
					let itemSize =
							this.itemSizeCache.get(item.key) ?? item.size,
						delta = size - itemSize;
					delta !== 0 &&
					...
					return notUndefined(
						measurements[
							findNearestBinarySearch(
								...
								(index) =>
									notUndefined(measurements[index]).start,
								offset,
							)
						],
					);
							...
							(this.scrollElement
								? 'document' in this.scrollElement
									? this.scrollElement.document
											.documentElement[scrollSizeProp]
				...
				(this.getOffsetForIndex = (index, align = 'auto') => {
					index = Math.max(
						0,
						Math.min(index, this.options.count - 1),
					);
					let measurement = notUndefined(
						this.getMeasurements()[index],
					);
					if (align === 'auto')
						if (
							measurement.end >=
				...
				(this.scrollToIndex = (
					...
					let [toOffset, align] = this.getOffsetForIndex(
						index,
						initialAlign,
					);
						...
						behavior !== 'smooth' &&
							...
							(this.scrollToIndexTimeoutId = setTimeout(() => {
								if (
									...
									let [toOffset2] = this.getOffsetForIndex(
										index,
										align,
									);
			...
			let handleArrowKeys = (event) => {
				...
				if (event.code === 'ArrowUp' && activeElement) {
					if (isActiveElementInput) {
						(0, import_react_dom2.flushSync)(() => {
							rowVirtualizer.scrollToIndex(maxIndex - 1, {
								align: 'start',
							});
						}),
							setTimeout(() => {
					...
					if (
						...
						document
							.querySelector(`[data-index="${selectedItem}"]`)
							?.focus();
						return;
					}
...
var ChevronRightIconStyled = newStyled(ChevronRightIcon)(({ theme }) => ({
	...
	FileSearchList = (0, import_react24.memo)(function ({
		...
		let [selectedItem, setSelectedItem] = (0, import_react24.useState)(
				null,
			),
				...
				({ virtualItem, searchResult, itemId }) => {
					searchResult?.exportedComponents?.length > 1
						...
						: searchResult?.exportedComponents?.length === 1 &&
						  onNewStory({
								componentExportName:
									searchResult.exportedComponents[0].name,
				...
				({ searchResult, component, id }) => {
					onNewStory({
						...
						componentExportCount:
							searchResult.exportedComponents.length,
					});
				},
				[onNewStory],
			),
							...
							rowVirtualizer
								...
								.map((virtualItem) => {
									let searchResult =
										...
										noExports =
											searchResult.exportedComponents ===
												null ||
											searchResult.exportedComponents
												?.length === 0,
										itemProps = {};
...
var MODAL_HEIGHT = 418,
	...
	FileSearchModal = ({
		...
		let [modalContentRef, modalContentDimensions] = useMeasure(),
			...
			[searchInputValue, setSearchInputValue] = (0,
			import_react26.useState)(fileSearchQuery);
		return (
...
var stringifyArgs = (args) =>
	...
	CreateNewStoryFileModal = ({ open, onOpenChange }) => {
		let [isLoading, setLoading] = (0, import_react27.useState)(!1),
			[fileSearchQuery, setFileSearchQuery] = (0,
			import_react27.useState)(''),
			...
			api = useStorybookApi(),
			[searchResults, setSearchResults] = (0, import_react27.useState)(
				null,
			),
			handleSuccessfullyCreatedStory = (0, import_react27.useCallback)(
				(componentExportName) => {
					api.addNotification({
						...
						duration: 8e3,
						icon: import_react27.default.createElement(
							CheckIcon,
							null,
						),
					}),
					...
					try {
						...
						try {
							let argTypes = (
								...
								requiredArgs =
									extractSeededRequiredArgs(argTypes);
							await experimental_requestResponse(
								channel,
								SAVE_STORY_REQUEST,
								SAVE_STORY_RESPONSE,
								{
									...
									importPath:
										createNewStoryResult.storyFilePath,
									csfId: storyId,
								},
							);
						} catch {}
...
var { document: document6 } = scope,
	...
	Search = import_react28.default.memo(function ({
		...
		let api = useStorybookApi(),
			...
			[allComponents, showAllComponents] = (0, import_react28.useState)(
				!1,
			),
			searchShortcut = api
			...
			stateReducer2 = (0, import_react28.useCallback)(
				(state, changes) => {
					switch (changes.type) {
				...
				return import_react28.default.createElement(
					...
					import_react28.default.createElement(
						...
						children({
							...
							isBrowsing:
								!isOpen &&
								document6.activeElement !== inputRef.current,
							closeMenu,
							getMenuProps,
							getItemProps,
							highlightedIndex,
...
var import_debounce = __toESM(require_debounce()),
	...
	useLastViewed = (selection) => {
		let initialLastViewedStoryIds = (0, import_react30.useMemo)(() => {
			...
			lastViewedRef = (0, import_react30.useRef)(
							...
							import_react31.default.createElement(
								...
								import_react31.default.createElement(
									SearchResults,
									{
										...
										isLoading,
										clearLastViewed:
											lastViewedProps.clearLastViewed,
									},
								),
							),
					),
			...
			isLoading
				...
				: import_react31.default.createElement(
						...
						bottom.map(({ id, render: Render }) =>
							import_react31.default.createElement(Render, {
								key: id,
							}),
						),
				  ),
		...
		let theme = useTheme(),
			...
			documentation = (0, import_react32.useMemo)(
				() => ({
					...
					icon: import_react32.default.createElement(
						ShareAltIcon,
						null,
					),
				}),
...
function ZoomToolRenderer() {
	return import_react34.default.createElement(
		...
		import_react34.default.createElement(
			...
			null,
			({ set, value }) =>
				import_react34.default.createElement(ZoomWrapper, {
					set,
					value,
				}),
		),
	...
	remountTool = {
		...
		render: () =>
			import_react39.default.createElement(
				...
				{ filter: menuMapper2 },
				({ remount, storyId, api }) => {
					let [isAnimating, setIsAnimating] = (0,
						import_react39.useState)(!1),
						remountComponent = () => {
							storyId && remount();
						};
					return (
...
var fullScreenMapper = ({ api, state }) => ({
		...
		hasPanel:
			Object.keys(api.getElements(Addon_TypesEnum.PANEL)).length > 0,
		singleStory: state.singleStory,
	}),
	fullScreenTool = {
		title: 'fullscreen',
...
function IFrame(props) {
	...
	return import_react41.default.createElement(
		...
		import_react41.default.createElement(StyledIframe, {
			...
			onLoad: (e3) =>
				e3.currentTarget.setAttribute('data-is-loaded', 'true'),
			id,
			title,
			src,
	...
	FramesRenderer = ({
		...
		return (
			frames['storybook-preview-iframe'] ||
				(frames['storybook-preview-iframe'] = getStoryHref(
					baseUrl,
					storyId,
					{ ...queryParams, ...(version && { version }), viewMode },
				)),
			...
			(0, import_react43.useEffect)(() => {
				if (scope.CONFIG_TYPE === 'DEVELOPMENT')
					try {
						addons
							.getChannel()
							.on(PREVIEW_BUILDER_PROGRESS, (options2) => {
		...
		({
			...
			return import_react46.default.createElement(
				Tabs,
				{
					...
					emptyState: import_react46.default.createElement(
						EmptyTabContent,
						{
	...
	return (
		(0, import_react48.useEffect)(() => {
			let panelResizer = panelResizerRef.current,
				...
				previewIframe = document.querySelector(
					'#storybook-preview-iframe',
				),
				draggedElement = null,
				onDragStart = (e3) => {
			...
			return (
				...
				() => {
					panelResizer?.removeEventListener('mousedown', onDragStart),
						sidebarResizer?.removeEventListener(
							'mousedown',
							onDragStart,
						),
						previewIframe?.removeAttribute('style');
				...
				import_react52.default.createElement(
					...
					import_react52.default.createElement(
						...
						import_react52.default.createElement(
							...
							import_react52.default.createElement(ShareAltIcon, {
								width: 12,
							}),
						),
						import_react52.default.createElement(
...
var useFullStoryName = () => {
		...
		let fullStoryName =
				currentStory.renderLabel?.(currentStory, api) ||
				currentStory.name,
		...
		for (
			...
			(node = index[node.parent]),
				(fullStoryName = `${
					node.renderLabel?.(node, api) || node.name
				}/${fullStoryName}`);
...
var MINIMUM_CONTENT_WIDTH_PX = 100,
		...
		(0, import_react59.useEffect)(() => {
			...
			(0, import_react59.useLayoutEffect)(() => {
				...
				let nextState = {
					...
					bottomPanelHeight:
						internalDraggingSizeState.bottomPanelHeight,
	...
	PanelContainer = newStyled.div(({ theme, position }) => ({
		...
		backgroundColor: theme.background.content,
		borderTop:
			position === 'bottom' ? `1px solid ${theme.color.border}` : null,
		borderLeft:
			position === 'right' ? `1px solid ${theme.color.border}` : null,
	})),
	Drag = newStyled.div(
		({ theme }) => ({
			position: 'absolute',
...
var App = ({ managerLayoutState, setManagerLayoutState, pages, hasTab }) => {
	...
	return import_react60.default.createElement(
		...
		import_react60.default.createElement(Layout, {
			...
			slotPanel: import_react60.default.createElement(
				Panel_default,
				null,
			),
...
var Container8 = newStyled.div({
	...
	StyledLink = newStyled(Link22)(({ theme }) => ({
		'&&': {
			fontWeight: theme.typography.weight.bold,
			color:
				theme.base === 'light' ? theme.color.dark : theme.color.light,
		},
		'&:hover': {
			color:
				theme.base === 'light'
...
var Centered = newStyled.div({
	...
	WhatsNewScreen = () => {
		let api = useStorybookApi(),
			...
			[didHitMaxWaitTime, setDidHitMaxWaitTime] = (0,
			import_react66.useState)(!1);
		if (
		...
		import_react68.default.createElement(
			...
			import_react68.default.createElement(
				...
				import_react68.default.createElement(
					Route2,
					{ path: 'about' },
					import_react68.default.createElement(AboutPage, {
						key: 'about',
					}),
				),
				import_react68.default.createElement(
		...
		return import_react69.default.createElement(
			...
			(locationData) =>
				import_react69.default.createElement(
					...
					(combo) => {
						let { state, api } = combo,
							setManagerLayoutState = (0,
							import_react69.useCallback)(
								(sizes) => {
									api.setSizes(sizes);
								},
								[api],
