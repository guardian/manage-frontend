try {
	(() => {
		...
		var gc = (e, t, n) => (
			...
			el = (e) => Xo(za({}, '__esModule', { value: !0 }), e);
		var be = Ua(() => {});
		var Ke,
			Ee = Ua(() => {
				Ke = {
		...
		fc($a, {
			...
			StrictMode: () => wc,
			Suspense: () => Cc,
			__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: () => Sc,
			cloneElement: () => xc,
			createContext: () => Je,
			createElement: () => x,
			createFactory: () => Mc,
		...
		var gl = hc((Jn, vi) => {
			...
			(function (e, t) {
				typeof Jn == 'object' && typeof vi == 'object'
					? (vi.exports = t((qn(), el($a))))
					: typeof define == 'function' && define.amd
					? define(['react'], t)
					: typeof Jn == 'object'
					? (Jn.ReactConfetti = t((qn(), el($a))))
				...
				return (function (t) {
					...
					function (t, n, r) {
						...
						(function (C) {
							...
							(function (C) {
								(C[(C.Positive = 1)] = 'Positive'),
									(C[(C.Negative = -1)] = 'Negative');
							})(o || (o = {}));
						var g = (function () {
							function C(ie, re, P, ge) {
								(function (ii, $n) {
									if (!(ii instanceof $n))
										throw new TypeError(
							...
							(function (re, P) {
								...
								f(this, 'animate', function () {
									...
									return (
										...
										N.particles.forEach(function (Gn, Jo) {
											Gn.update(),
												(Gn.y > re.height ||
													Gn.y < -100 ||
													Gn.x > re.width + 100 ||
								...
								function C(ie, re) {
									...
									(function (ye, fe) {
										...
										v(this, 'reset', function () {
											P.generator &&
												P.generator.particlesGenerated >
													0 &&
										...
										(this.canvas = ie);
									var ge = this.canvas.getContext('2d');
									if (!ge)
										throw new Error(
						...
						function B(C) {
							return (
								(function (M) {
									if (Array.isArray(M)) return Se(M);
								})(C) ||
								(function (M) {
									if (
										typeof Symbol < 'u' &&
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
						...
						function Ae(C, M) {
							if (C) {
								if (typeof C == 'string') return Se(C, M);
						...
						function Se(C, M) {
							...
							for (var F = 0, N = new Array(M); F < M; F++)
								N[F] = C[F];
							return N;
						}
						function Qe(C, M) {
							...
							zn = (function (C) {
								...
								function re(P) {
									...
									return (
										...
										Qt(bt(ge), 'confetti', void 0),
										(ge.canvas = P.canvasRef || ri),
										ge
									);
								}
								return (
						...
						Qt(zn, 'defaultProps', ce({}, E)),
							Qt(zn, 'displayName', 'ReactConfetti');
		...
		var df = __STORYBOOK_API__,
			{
				...
				ManagerContext: pf,
				Provider: hf,
				RequestResponseError: ff,
				addons: Yn,
				combineParameters: gf,
				controlOrMetaKey: vf,
				controlOrMetaSymbol: yf,
				eventMatchesShortcut: bf,
				eventToShortcut: Ef,
				experimental_requestResponse: kf,
				isMacLike: wf,
				isShortcutTaken: Cf,
				keyToSymbol: Sf,
				merge: xf,
				mockChannel: Mf,
				optionOrAltSymbol: Nf,
				shortcutMatchesShortcut: Ff,
				shortcutToHumanString: Af,
				types: Of,
				useAddonState: tl,
				useArgTypes: Lf,
				useArgs: Tf,
		...
		function gi(
			...
			if (typeof J !== $c) throw new TypeError(Gc);
			if (
				(Y && (h = -h),
				(b === -1 || isNaN(b)) &&
					((b = Math.floor(Math.log(h) / Math.log(B))),
					b < 0 && (b = 0)),
				b > 8 && (k > 0 && (k += 8 - b), (b = 8)),
				m === Uc)
			)
				return b;
			if (h === 0) (v[0] = 0), (S = v[1] = fi.symbol[u][t ? dl : ul][b]);
			else {
			...
			if (
				...
				o === !0
					...
					: s.length > 0 && (v[0] = v[0].toString().replace(pl, s)),
				n && Number.isInteger(v[0]) === !1 && i > 0)
			) {
				let ce = s || pl,
					Ce = v[0].toString().split(ce),
					Ae = Ce[1] || En,
					Se = Ae.length,
					Qe = i - Se;
				v[0] = `${Ce[0]}${ce}${Ae.padEnd(Se + Qe, nd)}`;
			}
			return (
				j &&
					(v[1] = g[b]
				...
				m === Hc
					? v
					: m === qc
					? { value: v[0], symbol: v[1], exponent: b, unit: S }
					: v.join(c)
			);
		}
		be();
		...
		var Qn = __REACT_DOM__,
			{
				__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: N9,
				createPortal: Kn,
				createRoot: F9,
				findDOMNode: A9,
				flushSync: O9,
				...
				unstable_renderSubtreeIntoContainer: fl,
				version: I9,
			} = __REACT_DOM__;
		var J1 = gc(gl(), 1);
		be();
		...
		var id = Object.create,
			...
			dd = ((e) =>
				typeof Kt < 'u'
					...
					: typeof Proxy < 'u'
					? new Proxy(e, {
							get: (t, n) => (typeof Kt < 'u' ? Kt : t)[n],
					  })
					: e)(function (e) {
				if (typeof Kt < 'u') return Kt.apply(this, arguments);
				throw new Error(
				...
				if ((t && typeof t == 'object') || typeof t == 'function')
					for (let i of ld(t))
						!cd.call(e, i) &&
							...
							X1(e, i, {
								get: () => t[i],
								enumerable: !(r = od(t, i)) || r.enumerable,
							});
				return e;
			},
			ht = (e, t, n) => (
				...
				ud(
					t || !e || !e.__esModule
						? X1(n, 'default', { value: e, enumerable: !0 })
						: n,
					e,
				)
			),
				...
				function l(d) {
					return function (u, m, p, g) {
						...
						var f = o(),
							...
							h = !1;
						return (
							y === m ? g(n, u[d]) : requestAnimationFrame(E), v
						);
						function v() {
							h = !0;
						}
			...
			pd = Yt((e, t) => {
				(function (n, r) {
					...
					function n(i) {
						...
						return (
							o.indexOf('scroll') > -1 || o.indexOf('auto') > -1
						);
					}
					function r(i) {
						if (
			...
			bo = Yt((e, t) => {
				...
				function i(v) {
					...
					return (
						E === '[object RegExp]' || E === '[object Date]' || s(v)
					);
				}
				...
				function d(v, E) {
					return E.clone !== !1 && E.isMergeableObject(v)
						? b(c(v), v, E)
						: v;
				}
				function u(v, E, S) {
			...
			yd = Q(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				x(
					'svg',
					{
						width: t,
			...
			ts = Q(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				x(
					'svg',
					{
						width: t,
			...
			Eo = Q(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				x(
					'svg',
					{
						width: t,
			...
			vl = Q(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				x(
					'svg',
					{
						width: t,
			...
			),
			{
				...
				CHROMATIC_BASE_URL: jr = jd || 'https://www.chromatic.com',
				CHROMATIC_API_URL: Hd = `${jr}/api`,
			} = Ke,
			z = 'chromaui/addon-visual-tests',
			ln = `${z}/panel`,
			Dd = `${z}/sidebarTop`,
			zd = `${z}/sidebarBottom`,
			Hi = `${z}/access-token/${jr}`,
			wo = `${z}/configInfo`,
			yl = `${z}/configInfoDismissed`,
			Ud = `${z}/gitInfo`,
			ls = `${z}/gitInfoError`,
			ss = `${z}/projectInfo`,
			cs = `${z}/isOffline`,
			...
			$d = `${z}/startBuild`,
			Wd = `${z}/stopBuild`,
			ds = `${z}/localBuildProgress`,
			Gd = `${z}/selectedModeName`,
			qd = `${z}/selectedBrowserId`,
			Yd = `${z}/telemetry`,
			us = `${z}/enableFilter`,
			ms = `${z}/removeAddon`,
			Qd = {
			...
			ps = 'https://www.chromatic.com/docs/visual-tests-addon',
			Kd = ht(Vr()),
			Jd = (e, t) =>
				(t &&
					{
			...
			ot = w(ol)(
				...
				({ active: e, status: t, theme: n }) => !e && Jd(n, t),
				({ active: e, theme: t }) => {
			...
			bl = ({ active: e, count: t, label: n, status: r, ...i }) =>
				a.createElement(
					e5,
					{ active: e, ...i },
					a.createElement(
					...
					a.createElement(t5, null, (0, Kd.default)(n, t)),
				),
			n5 = () => !0,
			a5 = ({ status: e }) => e?.[z]?.status === 'warn',
			r5 = ({ status: e }) => e?.[z]?.status === 'error',
			i5 = ({ status: e }) =>
				e?.[z]?.status === 'warn' || e?.[z]?.status === 'error',
			o5 = (e = !1, t = !1) => (e && t ? i5 : e ? a5 : t ? r5 : n5),
			l5 = w.div({ display: 'flex', gap: 5 }),
			s5 = ({ api: e, status: t }) => {
				...
				return (
					oe(() => {
						let p = o5(c && n, d && i);
						e.experimental_setFilter(z, p), e.emit(us, p);
					}, [e, c, d, n, i]),
					!c && !d
						? null
						: a.createElement(
			...
			c5 = (e) => {
				let { status: t } = yn();
				return a.createElement(s5, { ...e, status: t });
			},
			Ei = ht(Vr()),
			Co = () => {},
			et = Co;
				...
				t((s) => {
					...
					n(
						ft((s) => {
							if (s === 1) {
								l || ((l = !0), i(1));
								for (var c = 0, d = r, u = r.length; c < u; c++)
									d[c](1);
								r.length = 0;
							} else {
								!l && !o ? ((o = !0), i(0)) : (o = !1);
								for (var m = 0, p = r, g = r.length; m < g; m++)
									p[m](0);
							}
						}),
					);
			...
			return (i) => {
				t.push(i),
					t.length === 1 &&
						e((o) => {
							if (o === 0) {
								for (var l = 0, s = t, c = t.length; l < c; l++)
									s[l](0);
								t.length = 0;
							} else if (o.tag === 0) n = o[0];
							else {
								r = !1;
								for (var d = 0, u = t, m = t.length; d < m; d++)
									u[d](o);
							}
						}),
					i(
		...
		function $i() {
			var e, t;
			return {
				source: va(vs((n) => ((e = n.next), (t = n.complete), Co))),
				next(n) {
					e && e(n);
				},
				complete() {
		...
		var g5 = {
			...
			ee;
		function Le(e) {
			return new Wi(`Syntax Error: Unexpected token at ${ee} in ${e}`);
		}
		function Xe(e) {
			if (((e.lastIndex = ee), e.test(we)))
				return we.slice(ee, (ee = e.lastIndex));
		}
		var Ga = / +(?=[^\s])/y;
		function v5(e) {
			for (
...
`),
				...
				(Ga.lastIndex = 0),
					Ga.test(t[l]) &&
						(l && (!r || Ga.lastIndex < r) && (r = Ga.lastIndex),
						(i = i || l),
						(o = l));
			for (var s = i; s <= o; s++)
				s !== i &&
...
`),
		...
		function ae() {
			for (
				...
				e === 44 ||
				e === 65279;
				e = 0 | we.charCodeAt(ee++)
			)
				if (e === 35)
					for (; (e = we.charCodeAt(ee++)) !== 10 && e !== 13; );
			ee--;
		}
		var ys = /[_A-Za-z]\w*/y;
		function Nt() {
			var e;
			if ((e = Xe(ys))) return { kind: 'Name', value: e };
		}
		var y5 = /(?:null|true|false)/y,
			bs = /\$[_A-Za-z]\w*/y,
			b5 = /-?\d+/y,
			E5 = /(?:\.\d+)?[eE][+-]?\d+|\.\d+/y,
			k5 = /\\/g,
		...
		function ur(e) {
			...
			if ((n = Xe(y5)))
				...
				t = {
					kind: 'Variable',
					name: { kind: 'Name', value: n.slice(1) },
				};
			else if ((n = Xe(b5))) {
				var r = n;
				(n = Xe(E5))
			...
			} else if ((n = Xe(ys))) t = { kind: 'EnumValue', value: n };
			else if ((n = Xe(w5)))
				t = {
					kind: 'StringValue',
					value: v5(n.slice(3, -3)),
					block: !0,
				};
			else if ((n = Xe(C5)))
				t = {
					kind: 'StringValue',
					value: k5.test(n) ? JSON.parse(n) : n.slice(1, -1),
					block: !1,
				};
			else if (
				(t =
					(function (i) {
						var o;
						if (we.charCodeAt(ee) === 91) {
							ee++, ae();
							for (var l = []; (o = ur(i)); ) l.push(o);
							if (we.charCodeAt(ee++) !== 93)
								throw Le('ListValue');
							return ae(), { kind: 'ListValue', values: l };
						}
					})(e) ||
					(function (i) {
						if (we.charCodeAt(ee) === 123) {
							ee++, ae();
							for (var o = [], l; (l = Nt()); ) {
								if ((ae(), we.charCodeAt(ee++) !== 58))
									throw Le('ObjectField');
								ae();
								var s = ur(i);
							...
							if (we.charCodeAt(ee++) !== 125)
								throw Le('ObjectValue');
		...
		function Es(e) {
			...
			if ((ae(), we.charCodeAt(ee) === 40)) {
				...
				if (!t.length || we.charCodeAt(ee++) !== 41)
					throw Le('Argument');
				ae();
			}
			return t;
		...
		function An(e) {
			var t = [];
			for (ae(); we.charCodeAt(ee) === 64; ) {
				ee++;
				var n = Nt();
				if (!n) throw Le('Directive');
				ae(), t.push({ kind: 'Directive', name: n, arguments: Es(e) });
			}
			return t;
		}
		function S5() {
		...
		function ks() {
			var e;
			if ((ae(), we.charCodeAt(ee) === 91)) {
				ee++, ae();
				var t = ks();
				if (!t || we.charCodeAt(ee++) !== 93) throw Le('ListType');
		...
		function Dr() {
			var e;
			if ((ae(), we.charCodeAt(ee) === 123)) {
				ee++, ae();
				for (var t = []; (e = N5() || S5()); ) t.push(e);
				if (!t.length || we.charCodeAt(ee++) !== 125)
					throw Le('SelectionSet');
		...
		var O5 = /(?:query|mutation|subscription)/y;
		function L5() {
			var e,
				t,
				n = [],
...
"""`
		...
		var nt = (e) => !(!e || !e.length),
			Ve = {
						...
						nt(e.variableDefinitions) &&
							...
							(t +=
								...
								e.variableDefinitions
									.map(Ve.VariableDefinition)
									.join(', ') +
								')')),
						nt(e.directives) &&
							(t +=
								' ' + e.directives.map(Ve.Directive).join(' ')),
				...
				Field(e) {
					var t =
						(e.alias ? e.alias.value + ': ' : '') + e.name.value;
					if (nt(e.arguments)) {
...
`,
  ...
  `,
				...
				StringValue: (e) => (e.block ? Z5(e.value) : _5(e.value)),
				...
				ObjectValue: (e) =>
					'{' + e.fields.map(Ve.ObjectField).join(', ') + '}',
				...
				Directive(e) {
					...
					return (
						nt(e.arguments) &&
							(t +=
								'(' +
								e.arguments.map(Ve.Argument).join(', ') +
								')'),
						t
					);
				},
...
`),
			...
			Gi = (e, t) => {
				for (
					var n = 0 | (t || 5381), r = 0, i = 0 | e.length;
					r < i;
					r++
				)
			...
			Cl = new WeakMap(),
			wn = (e) => {
				if (e === null || rn.has(e)) return 'null';
				if (typeof e != 'object') return JSON.stringify(e) || '';
				if (e.toJSON) return wn(e.toJSON());
				if (Array.isArray(e)) {
					var t = '[';
					for (var n of e)
						t.length > 1 && (t += ','), (t += wn(n) || 'null');
					return (t += ']');
				} else if (
					(pr !== On && e instanceof pr) ||
					(hr !== On && e instanceof hr)
				)
					return 'null';
				...
				if (
					...
					var i = Cl.get(e) || Math.random().toString(36).slice(2);
					return Cl.set(e, i), wn({ __key: i });
				}
				rn.add(e);
				var o = '{';
				for (var l of r) {
...
`,
					...
					: e,
			Sl = (e) => e.split(R5).map(P5).join('').trim(),
			xl = new Map(),
			or = new Map(),
			No = (e) => {
				var t;
...
# ${n}`,
			...
			V5 = (e) => {
				...
				return (
					typeof e == 'string'
						? ((t = Ml(e)), (n = or.get(t) || T5(e)))
						: ((t = e.__key || Ml(e)), (n = or.get(t) || e)),
					n.loc || No(n),
					(n.__key = t),
					or.set(t, n),
					n
			...
			Cs = (e) => {
				for (var t of e.definitions)
					if (t.kind === g5.OPERATION_DEFINITION)
						return t.name ? t.name.value : void 0;
			},
			Nl = (e, t, n) => {
				if (
					!('data' in t || ('errors' in t && Array.isArray(t.errors)))
				)
				...
				return {
					...
					error: Array.isArray(t.errors)
						? new Mo({ graphQLErrors: t.errors, response: n })
						: void 0,
			...
			Yi = (e, t) => {
				if (
					...
					for (var n of Object.keys(t)) e[n] = Yi(e[n], t[n]);
					return e;
				}
				return t;
			},
			j5 = (e, t, n, r) => {
				...
				if (s) {
					var d = function (m) {
						Array.isArray(m.errors) && i.push(...m.errors),
							m.extensions &&
								(Object.assign(l, m.extensions), (o = !0));
						var p = 'data',
							g = c,
							f = [];
						if (m.path) f = m.path;
						...
						if (m.items)
							for (
								...
								g[h + v] = Yi(g[h + v], m.items[v]);
						else m.data !== void 0 && (g[p] = Yi(g[p], m.data));
					};
					for (var u of s) d(u);
				...
				return {
					...
					data: c.data,
					error: i.length
						? new Mo({ graphQLErrors: i, response: n })
						: void 0,
			...
			Ss = (e, t, n) => ({
				operation: e,
				data: void 0,
				error: new Mo({ networkError: t, response: n }),
				extensions: void 0,
				hasNext: !1,
				stale: !1,
			});
		...
		var D5 = (e, t) => {
				...
				for (var i in t) {
					var o = t[i];
					o &&
						r.searchParams.set(i, typeof o == 'object' ? mr(o) : o);
				}
				var l = r.toString();
			...
			$5 = typeof TextDecoder < 'u' ? new TextDecoder() : null,
			W5 = /boundary="?([^=";]+)"?/i,
			G5 = /data: ?([^\n]+)/,
			Fl = (e) =>
				e.constructor.name === 'Buffer' ? e.toString() : $5.decode(e);
		async function* Al(e) {
			if (e.body[Symbol.asyncIterator])
				for await (var t of e.body) yield Fl(t);
			else {
				var n = e.body.getReader(),
					r;
				try {
					for (; !(r = await n.read()).done; ) yield Fl(r.value);
				} finally {
					n.cancel();
				}
			}
...
`,
		...
		var Qi = (e, t) => {
			...
			if (Array.isArray(e)) return e.map((i) => Qi(i));
		...
		function Ll(e) {
			...
			return (
				(t.toPromise = () =>
					xo(Hr(1)(qe((n) => !n.stale && !n.hasNext)(t)))),
		...
		var Q5 = () => {},
			...
			tu = function e(t) {
				...
				var p = (h) => {
						var v = hs(
							qe((E) => E.kind === 'teardown' && E.key === h.key)(
								c.source,
							),
						)(
							qe(
					...
					f = Object.assign(g, {
						...
						createRequestOperation(h, v, E) {
							return (
								...
								fr(h, v, {
									...
									...E,
									requestPolicy:
										E.requestPolicy || s.requestPolicy,
									suspense:
										E.suspense ||
										(E.suspense !== !1 && f.suspense),
								})
							);
						},
						...
						executeSubscription(h, v) {
							var E = f.createRequestOperation(
								'subscription',
								h,
								v,
							);
						...
						subscription: (h, v, E) =>
							f.executeSubscription(Mn(h, v), E),
					...
					function p() {
						d = Promise.resolve()
							.then(() =>
								e({
									mutate(b, h, v) {
										var E = t.createRequestOperation(
											'mutation',
											Mn(b, h),
											v,
										);
					...
					var y = qe(Boolean)(
							zi((b) =>
								b.kind === 'teardown'
									? (l.delete(b.key), b)
									: b.context._instance &&
									  r.has(b.context._instance)
									? b
									: b.context.authAttempt
									? f(b)
									: d || !u
									? (d || p(),
									  l.has(b.key) || l.set(b.key, ki(b, !1)),
									  null)
									: (function (h) {
											return (
						...
						qe((b) =>
							...
							(function (h) {
								return (
									u &&
									u.didAuthError &&
									u.didAuthError(h.error, h.operation)
								);
							})(b) &&
		...
		var Fo = () => {
			...
			wi = (e, t) => {
				...
				return ((r, i) => {
					...
					for (var l in i)
						if (l === 'operation' ? !iu(r[l], i[l]) : r[l] !== i[l])
							return !0;
					return !1;
				})(e, n)
					? n
		...
		function Ao(e) {
			var t = Fo(),
				...
				[c, d] = Re(() => [o, wi(Ki, l(o, r)), s]),
				u = c[1];
			o !== c[0] && ou(c[2], s) && d([o, (u = wi(c[1], l(o, r))), s]),
				oe(() => {
					var p = c[0],
						g = c[2][1],
						f = !1,
		...
		var Ms = () => {
				let [{ token: e }, t] = tl(`${z}/accessToken`, { token: kt }),
					n = a.useCallback(
						(r) => {
							vr(r), t({ token: kt });
						},
				...
				exchanges: [
					...
					nu(async (e) => ({
						...
						didAuthError: (t) =>
							...
							t.graphQLErrors.some((n) =>
								n.message.includes('Must login'),
							),
						async refreshAuth() {
							vr(null);
						},
			...
			Ot = (e, t) => {
				let n = Jt(e);
				if (n == null)
					throw new Error(`Missing context value for ${t}`);
				return n;
			},
			Ur = Je(null),
			yu = ({ children: e, value: t }) =>
				a.createElement(Ur.Provider, { value: t }, e),
			tt = (e, t) => {
				let n = Ot(Ur, 'Telemetry');
				oe(() => n({ location: e, screen: t }), [e, t, n]);
			},
			Fs = ({ localBuildProgress: e, accessToken: t }) => {
				let n = di({}),
					r = Jt(Ur),
					[i, o] = Re(!1),
					[l, s] = Re(!1),
			...
			_l = 'experimental_useSharedState_getValue',
			...
			As = class {
				...
				get(e) {
					return (
						this.state[e] || this.channel.emit(_l, e),
						this.state[e]?.value
					);
				}
				set(e, t) {
					...
					(this.state[e] = { index: n, value: t }),
						this.channel.emit(Ya, e, t, n);
				}
				static subscribe(e, t) {
					let n = Ci.get(e) || new As(t);
					return (
						Ci.has(e) ||
							(Ci.set(e, n),
							n.channel.on(Ya, (r, i) => {
			...
			Ls = {
				...
				upload: {
					...
					renderProgress: ({ stepProgress: e }) => {
						...
						let { value: r, exponent: i } = gi(n, {
								output: 'object',
								round: 1,
							}),
							{ value: o, symbol: l } = gi(t, {
								exponent: i,
								output: 'object',
								round: 1,
							});
		...
		var G = w.div(
			...
			Oo = ({ localBuildProgress: e, withEmoji: t = !1, ...n }) => {
				let { emoji: r, renderProgress: i } = Ls[e.currentStep],
					o = i(e);
		...
		function eo(e) {
			...
			return (
				(eo = function (n) {
					...
					function r() {
						return Cu(n, arguments, Xi(this).constructor);
					}
					return (
		...
		function ba(e, t, n, r) {
			if ((r === void 0 && (r = Su), t === 0)) return r(n, n, n);
		...
		function _s(e) {
			...
			var o = Ou.exec(t.substring(0, 50));
			if (o)
				return {
					red: parseInt('' + o[1], 10),
			...
			var p = Tu.exec(t.substring(0, 50));
			if (p) {
		...
		function Mi(e) {
			return en(Math.round(e * 255));
		}
		function Iu(e, t, n) {
			return to('#' + Mi(e) + Mi(t) + Mi(n));
		}
		function br(e, t, n) {
			return ba(e, t, n, Iu);
		}
		...
		function Bu(e, t, n, r) {
			...
			if (
				...
				return e.alpha >= 1
					...
					: 'rgba(' +
							ba(e.hue, e.saturation, e.lightness) +
							',' +
							e.alpha +
							')';
			throw new wt(2);
		...
		function no(e, t, n) {
			if (
				...
				return to('#' + en(e) + en(t) + en(n));
			if (typeof e == 'object' && t === void 0 && n === void 0)
				return to('#' + en(e.red) + en(e.green) + en(e.blue));
			throw new wt(6);
		}
		function ao(e, t, n, r) {
		...
		function Du(e, t) {
			...
			var n = Zs(t);
			return Is(
				yr({}, n, { lightness: Ps(0, 1, n.lightness - parseFloat(e)) }),
			);
		}
		var zu = Bs(Du),
			tn = zu;
		...
		var $u = Bs(Uu),
			...
			Ka = 5.55555;
		pe({
			padding: `0 ${Lo.padding.medium}px`,
		...
		var Vs = Ht({
			...
			js = Ht({ '0%, 100%': { opacity: 1 }, '50%': { opacity: 0.4 } });
		Ht({
		...
		var Wu = pe({
				...
				definitions: [
					{
						...
						name: {
							kind: 'Name',
							value: 'VisualTestsProjectCountQuery',
						},
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
			...
			zs = ({ status: e }) => a.createElement(Ds, { status: e }),
			r2 = w.div({
				position: 'relative',
				display: 'inline-flex',
			...
			Er = ({ status: e, children: t }) =>
				a.createElement(
					...
					null,
					t,
					a.createElement(Ds, { overlay: !0, status: e }),
				),
			je = w(cl)(({ theme: e }) => ({
				marginBottom: '-4px',
				marginTop: '-4px',
				...
				if (e)
					return o
						? a.createElement(
								Oe,
								{
									tooltip: a.createElement(je, { note: o }),
									trigger: 'hover',
									hasChrome: !1,
								},
								a.createElement(
			...
			c2 = ({ api: e }) => {
					...
					j = W(
						(Te) => {
							if (
								...
								let Ne = Object.keys(h).indexOf(E),
									Bt = Object.entries(h).slice(
										Ne > 0 ? Ne : 0,
									),
									[_e] =
										Bt.find(
							...
							Te && l?.({ action: 'openWarning', warning: Te });
						},
						[i, o, l, h, r, E, S],
					),
					Y = W(
				...
				oe(() => {
					let Te = () => m(!0),
						Ne = () => m(!1);
					return (
						window.addEventListener('offline', Te),
						window.addEventListener('online', Ne),
						() => {
							window.removeEventListener('offline', Te),
								window.removeEventListener('online', Ne);
						}
					);
				}, [m]),
					oe(() => {
						g?.currentStep !== b.current &&
							((b.current = g?.currentStep),
							g?.currentStep === 'initialize' &&
								(t({
									id: `${z}/build-initialize`,
									content: {
										headline: 'Build started',
										subHeadline:
											'Check the visual test addon to see the progress of your build.',
									},
									icon: a.createElement(ji, {
										color: Lt.positive,
									}),
									duration: 8e3,
									onClick: Y,
								...
								setTimeout(
									() => n(`${z}/build-initialize`),
									8e3,
								)),
							g?.currentStep === 'aborted' &&
								(t({
									id: `${z}/build-aborted`,
									content: {
									...
									icon: a.createElement(Wt, {
										color: Lt.negative,
									}),
									duration: 8e3,
									onClick: Y,
								}),
								setTimeout(() => n(`${z}/build-aborted`), 8e3)),
							g?.currentStep === 'complete' &&
								(t({
									id: `${z}/build-complete`,
									content: {
										headline: 'Build complete',
										subHeadline: g.errorCount
											? `Encountered ${(0, Ei.default)(
													'component error',
													g.errorCount,
													!0,
											  )}`
				...
				let {
						...
						startBuild: Ce,
						stopBuild: Ae,
					} = Fs({ localBuildProgress: g, accessToken: c }),
					Se;
				s || (Se = 'Visual tests locked until a project is selected.'),
					d || (Se = 'Visual tests locked until you are logged in.'),
					k &&
						(Se =
							'Visual tests locked due to Git synchronization problem.'),
					y &&
						(Se =
							'Visual tests locked due to configuration problem.'),
					u && (Se = 'Visual tests locked while offline.');
				let Qe = W(() => j(Se), [j, Se]);
			...
			$s = Je(null),
			d2 = ({ children: e, value: t }) =>
				a.createElement($s.Provider, { value: t }, e),
			Ws = () => Ot($s, 'AuthState'),
			u2 = {
			...
			_o = ({ icon: e, ...t }) =>
				a.createElement(
					...
					a.createElement(a.Fragment, null, u2[e]),
				),
			nn = { large: 40, medium: 28, small: 20, tiny: 16 },
			p2 = w.div(
				{
				...
				(e) => ({
					...
					height: `${nn[e.size || 'medium']}px`,
					width: `${nn[e.size || 'medium']}px`,
					lineHeight: `${nn[e.size || 'medium']}px`,
					...(e.isLoading && {
						background: U.light,
						filter: 'grayscale(1)',
					}),
			...
			f2 = w.div(
				...
				(e) =>
					({
						tiny: {
							fontSize: `${D.size.s1 - 2}px`,
							lineHeight: `${nn.tiny}px`,
						},
						small: {
							fontSize: `${D.size.s1}px`,
							lineHeight: `${nn.small}px`,
						},
						medium: {
							fontSize: `${D.size.s2}px`,
							lineHeight: `${nn.medium}px`,
						},
						large: {
							fontSize: `${D.size.s3}px`,
							lineHeight: `${nn.large}px`,
						},
					}[e.size || 'medium']),
			),
			g2 = ({
			...
			y2 = w.a(
				{
					...
					'&:hover, &:focus-visible': {
						...
						color: tn(0.07, U.secondary),
					},
					'&:active': {
						transform: 'translateY(0)',
						color: tn(0.1, U.secondary),
					},
					svg: {
						display: 'inline-block',
						height: '1em',
				...
				(e) => ({
					...(e.secondary && {
						color:
							e.theme.base === 'light' ? U.mediumdark : U.medium,
						'&:hover': {
							color: e.theme.base === 'light' ? U.dark : U.light,
						},
						'&:active': {
							color:
								e.theme.base === 'light' ? U.darker : U.lighter,
						},
					}),
					...(e.tertiary && {
						color: U.dark,
			...
			Gs = Q(
				(
					...
					t
						? a.createElement(E2, { ...l, ref: s })
						: n
						? a.createElement(n, { ...l, ref: s })
						: a.createElement(b2, { ...l, ref: s }),
			);
		Gs.displayName = 'LinkComponentPicker';
		var $e = Q(({ children: e, withArrow: t, ...n }, r) => {
			let i = a.createElement(
				...
				a.createElement(
					...
					{ withArrow: !!t },
					e,
					t && a.createElement(_o, { icon: 'arrowright' }),
				),
			);
			return a.createElement(y2, { as: Gs, ref: r, ...n }, i);
		});
		$e.displayName = 'Link';
		$e.defaultProps = {
			withArrow: !1,
		...
		var k2 = w.label((e) => ({
			...
			C2 = w.input({
				...
				'&:-webkit-autofill': {
					WebkitBoxShadow: `0 0 0 3em ${U.lightest} inset`,
				},
			}),
			S2 = (e) => {
				let t = {
			...
			x2 = w.div((e) => ({
				...
				'.sbds-input-el': {
					...
					...(e.icon && {
						paddingLeft: 40,
						...((e.appearance === 'pill' ||
							e.appearance === 'code') && { paddingLeft: 30 }),
						'&:focus + svg path': { fill: U.darker },
					}),
					...(e.error && {
						boxShadow: `${U.red} 0 0 0 1px inset`,
						'&:focus': {
							boxShadow: `${U.red} 0 0 0 1px inset !important`,
						},
					}),
				},
				'> svg': {
			...
			Il = ({ error: e, value: t, lastErrorValue: n }) => {
			...
			qs = Q(
				(
					...
					let [h, v] = Re(
							Il({ error: r, value: y, lastErrorValue: c }),
						),
						E = `${e}-error`;
					oe(() => {
						v(Il({ error: r, value: y, lastErrorValue: c }));
					}, [y, r, c]);
					let S = a.createElement(C2, {
					...
					return a.createElement(
						...
						a.createElement(
							w2,
							{
								className: 'sbds-input-label-wrapper',
								hideLabel: o,
							},
							a.createElement(
								k2,
								{ htmlFor: e, appearance: t },
								s,
							),
						),
						a.createElement(
		...
		qs.displayName = 'PureInput';
		var Ys = Q(({ type: e, startFocused: t, ...n }, r) => {
			let [i, o] = Re(e),
				l = W(
					(u) => {
						if (
		...
		var O2 = w.div(
			...
			R2 = w.span({
				...
				'.sbds-list-item-left, .sbds-list-item-right': {
					flex: '0 1 auto',
				},
			...
			Zo = ({
				...
				'.sbds-list-item-title': {
					color:
						i.base === 'light' ? i.color.darker : i.color.lighter,
				},
			...
			B2 = w(({ active: e, activeColor: t, isLoading: n, ...r }) =>
				a.createElement('a', { ...r }),
			)(Zo),
			P2 = w.span(Zo),
			V2 = L2((e) =>
			...
			dt = ({
				...
				let d = Xt().color[e],
					u = a.createElement(
						...
						t &&
							a.createElement(
								T2,
								{ className: 'sbds-list-item-left' },
								t,
							),
						n &&
							a.createElement(
								_2,
								{ className: 'sbds-list-item-title' },
								n,
							),
						r &&
							a.createElement(
								Z2,
								{ className: 'sbds-list-item-center' },
								r,
							),
						i &&
							a.createElement(
								I2,
								{ className: 'sbds-list-item-right' },
								i,
							),
					);
				if (l) {
				...
				return a.createElement(
					Rl,
					null,
					a.createElement(s ? B2 : P2, { activeColor: d, ...c }, u),
				);
			};
		function da(e) {
			function t(B, j) {
			...
			for (
				s[s.length] = (c / o) | 0, s[s.length] = c, r = 0;
				r < s.length;
		...
		var j2 = (e) =>
			...
			H2 = (e) => window.btoa(Array.isArray(e) ? j2(e) : e),
			Bl = (e) =>
				H2(e).replace(/\+/g, '-').replace(/\//g, '_').replace(/=/g, ''),
			D2 = (e) =>
				Array.from(e.match(/.{1,2}/g) ?? [], (t) => parseInt(t, 16)),
			z2 = () =>
			...
			Qs = (e) =>
				Object.entries(e)
					...
					.join('&'),
			U2 = ({ error: e }) => e === 'authorization_pending',
			$2 = ({ error_description: e }) => e === 'Not OAuth beta user',
			W2 = async (e) => {
				let t = Bl(z2()),
					n = Bl(D2(da(t))),
			...
			G2 = async ({ expires: e, device_code: t, verifier: n }) => {
				if (Date.now() >= e)
					throw new Error(
						'Token exchange expired, please restart sign in.',
					);
				try {
					let r = await (
					...
					if ($2(r))
						return (
							alert(
								'You must be a beta user to use this addon at this time.',
							),
							null
						);
					throw new Error();
							...
							(s) => {
								...
								s == null
									...
									window.dispatchEvent(
										new StorageEvent('session-storage', {
											key: e,
										}),
									);
							},
		...
		function Y2(...e) {
			...
			e.length
				? (e.forEach((n) =>
						sessionStorage.removeItem(`${z}/state/${n}`),
				  ),
				  sessionStorage.setItem(
						`${z}/state`,
		...
		var Js = Je(void 0),
			...
			he = w.h1(({ theme: e }) => ({
				...
				fontWeight: 'bold',
				color:
					e.base === 'light' ? e.color.defaultText : e.color.lightest,
			})),
			Xs = (e) =>
				a.createElement(
					'svg',
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement('rect', {
								...
								fill: 'white',
								transform:
									'translate(7.20801 3.17212) rotate(45)',
							}),
						),
						a.createElement(
							'clipPath',
			...
			K2 = ht(Vr()),
			e0 = w.div({ display: 'flex', flexDirection: 'column' }),
			io = w.div(({ theme: e }) => ({
				padding: 15,
				lineHeight: '18px',
			...
			em = w(es)($r),
			tm = w(kd)($r),
			Ro = w(ko)({ marginLeft: 'auto' }),
			Bo = w(ot)({ margin: -5, marginLeft: 'auto' }),
			ue = w(mi)(
				{
					'&&': {
						display: 'inline-flex',
				...
				({ link: e, theme: t }) =>
					...
					pe({
						'&&': {
							...
							fontWeight: 'normal',
							color:
								t.base === 'light' ? t.color.dark : '#C9CDCF',
							opacity: 0.8,
			...
			nm = {
				...
				buildScriptName: {
					description:
						'The package.json script that builds your Storybook.',
					type: 'string',
				},
				cypress: {
					description:
				...
				storybookBuildDir: {
					description:
						'Path to the directory of an already built Storybook.',
					type: 'string',
				},
				storybookConfigDir: {
					description:
			...
			am = w(Bo)({ position: 'absolute', right: 16, top: 10 }),
			rm = w.div(({ theme: e }) => ({
			...
			im = w.div({ margin: '0 auto', maxWidth: 600, width: '100%' }),
			Vl = w.div(({ theme: e }) => ({
				borderBottom: `1px solid ${e.appBorderColor}`,
				marginBottom: 20,
				paddingBottom: 20,
			...
			om = w(kr)({ marginBottom: 10 }),
			lm = w.div({ display: 'flex', flexDirection: 'column', gap: 20 }),
			jl = w.div(({ theme: e }) => ({
				alignItems: 'center',
			...
			zl = w.div({ marginTop: 10 }),
			sm = w.div(({ hideBorderRadius: e, theme: t }) => ({
				background:
					t.base === 'dark' ? t.color.darkest : t.color.lighter,
			...
			cm = w.div(({ theme: e }) => ({ color: e.color.warningText })),
			Ul = w.div(({ theme: e }) => ({
				color: e.base === 'dark' ? e.color.medium : e.color.dark,
				marginTop: 2,
			})),
			$l = w.div(({ warning: e, theme: t }) => ({
				alignItems: 'center',
				display: 'flex',
				backgroundColor: e
					? t.base === 'dark'
			...
			t0 = { height: 12, margin: 2, verticalAlign: 'top', width: 12 },
			um = w(Ad)(t0),
			mm = w(Sd)(t0),
			pm = ({ onClose: e }) => {
				let { uninstallAddon: t } = Io(),
					[n] = Ie(wo),
					{
						configuration: r = {},
						problems: i = {},
				...
				return a.createElement(
					...
					a.createElement(
						...
						a.createElement(Ro, { 'aria-label': 'Close' }),
					),
					a.createElement(
						im,
						null,
			...
			fm = (e, t) => hm[t.type](e, t.payload),
			a0 = Je(n0),
			r0 = Je(() => {}),
			Wr = () => Ot(a0, 'Controls'),
			Pn = () => {
				let e = Ot(r0, 'ControlsDispatch');
				return jt(
					() => ({
						toggleDiff: (t) =>
							e({ type: 'toggleDiff', payload: t }),
						toggleFocus: (t) =>
							e({ type: 'toggleFocus', payload: t }),
						toggleConfig: (t) =>
							e({ type: 'toggleConfig', payload: t }),
						toggleSettings: (t) =>
							e({ type: 'toggleSettings', payload: t }),
						toggleWarnings: (t) =>
							e({ type: 'toggleWarnings', payload: t }),
			...
			gm = ({ children: e, initialState: t = n0 }) => {
				let [n, r] = ci(fm, t);
				return a.createElement(
					a0.Provider,
					{ value: n },
					a.createElement(r0.Provider, { value: r }, e),
				);
			},
			vm = w.div({ '& > div': { minWidth: 120 } }),
			...
			Gr = () => {
				let { accessToken: e, setAccessToken: t } = Ws(),
					{ toggleConfig: n } = Pn(),
					[r] = Ie(ss),
					{ projectId: i } = r || {},
					o = [
						...
						},
						{
							id: 'configuration',
							title: 'Configuration',
							icon: a.createElement(wd, { 'aria-hidden': !0 }),
							onClick: () => n(),
						},
						...(i
							? [
		...
		var ym = w.div(
			...
			bm = w(ua)({ alignItems: 'center', height: 40, margin: '0 10px' }),
			lt = w.div(
				{
					display: 'flex',
					flexDirection: 'column',
			...
			wm = ({
				...
				let [i] = Ie(wo),
					...
					[s, c] = Re(() => !!localStorage.getItem(yl)),
					d = W(() => {
						c(!0), localStorage.setItem(yl, 'true');
					}, []),
					u = a.createElement(
						$e,
						{
			...
			Me = ({
				...
				return a.createElement(
					...
					a.createElement(Gl, { hidden: i }, e),
					a.createElement(
						Gl,
						{ hidden: !i },
						a.createElement(pm, { onClose: () => o(!1) }),
					),
					t,
				);
			},
			...
			Mm = ({ value: e, placeholder: t, suffix: n }) =>
				a.createElement(
					xm,
					null,
			...
			Nm = ({ id: e, value: t, placeholder: n, suffix: r, ...i }) =>
				a.createElement(
					Sm,
					null,
					a.createElement(Ys, {
			...
			Om = ({ onBack: e, onSignIn: t }) => {
				let [n, r] = Re(''),
					...
					s = W(
						(c) => {
							c.preventDefault(),
								n ? t(n) : o('Please enter a subdomain');
						},
						[n, t],
					);
				return a.createElement(
			...
			Lm = ({ onBack: e, onSignIn: t, onSignInWithSSO: n }) =>
				a.createElement(
					Me,
					{ footer: null, ignoreConfig: !0 },
					a.createElement(Yr, { onBack: e }),
						...
						a.createElement(
							...
							a.createElement(
								...
								a.createElement(
									he,
									null,
									'Sign in to begin visual testing',
								),
								a.createElement(
									G,
									{ center: !0, muted: !0 },
		...
		var ka = (e, t) => {
				...
				switch (e.code) {
					...
					case A.unrecognized_keys:
						n = `Unrecognized key(s) in object: ${se.joinValues(
							e.keys,
							', ',
						)}`;
						break;
					...
					case A.invalid_union_discriminator:
						n = `Invalid discriminator value. Expected ${se.joinValues(
							e.options,
						)}`;
						break;
					case A.invalid_enum_value:
						n = `Invalid enum value. Expected ${se.joinValues(
							e.options,
						)}, received '${e.received}'`;
						break;
		...
		var We = class {
				...
				static async mergeObjectAsync(e, t) {
					let n = [];
					for (let r of t)
						n.push({ key: await r.key, value: await r.value });
			...
			o0 = (e) => ({ status: 'dirty', value: e }),
			Ge = (e) => ({ status: 'valid', value: e }),
			lo = (e) => e.status === 'aborted',
			so = (e) => e.status === 'dirty',
			wa = (e) => e.status === 'valid',
		...
		var te = class {
			...
			Rm = /^c[^\s-]{8,}$/i,
			Bm = /^[a-z][a-z0-9]*$/,
			Pm = /^[0-9A-HJKMNP-TV-Z]{26}$/,
			Vm =
				/^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
			jm =
				/^(?!\.)(?!.*\.\.)([A-Z0-9_+-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
			Hm = '^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$',
			Fi,
			Dm =
			...
			datetime(e) {
				...
				return typeof e == 'string'
					...
					: this._addCheck({
							kind: 'datetime',
							precision:
								typeof e?.precision > 'u' ? null : e?.precision,
							offset:
								(t = e?.offset) !== null && t !== void 0
									? t
									: !1,
		...
		var sn = class extends te {
			...
			get isInt() {
				return !!this._def.checks.find(
					(e) =>
						e.kind === 'int' ||
						(e.kind === 'multipleOf' && se.isInteger(e.value)),
				);
			}
			get isFinite() {
				let e = null,
		...
		on.create = (e) => new on({ typeName: $.ZodUnknown, ...K(e) });
		...
		var Mt = class extends te {
			_parse(e) {
				...
				if (
					...
					return Promise.all(
						[...t.data].map((o, l) =>
							r.type._parseAsync(new At(t, o, t.path, l)),
						),
					).then((o) => We.mergeArray(n, o));
				let i = [...t.data].map((o, l) =>
					r.type._parseSync(new At(t, o, t.path, l)),
				);
		...
		var Fe = class extends te {
			...
			_parse(e) {
				...
				if (
					!(
						this._def.catchall instanceof It &&
				...
				if (this._def.catchall instanceof It) {
					...
					if (s === 'passthrough')
						...
						o.length > 0 &&
							(Z(n, { code: A.unrecognized_keys, keys: o }),
							t.dirty());
					else if (s !== 'strip')
						throw new Error(
			...
			keyof() {
				return l0(se.objectKeys(this.shape));
			}
		};
		Fe.create = (e, t) =>
			new Fe({
				...
				function r(i) {
					...
					for (let l of i)
						if (l.result.status === 'dirty')
							return (
								t.common.issues.push(...l.ctx.common.issues),
								l.result
							);
		...
		Ma.create = (e, t) =>
			new Ma({ options: e, typeName: $.ZodUnion, ...K(t) });
		var sr = (e) =>
				e instanceof Fa
					? sr(e.schema)
					: e instanceof pt
		...
		var Na = class extends te {
			_parse(e) {
				let { status: t, ctx: n } = this._processInputParams(e),
					r = (i, o) => {
						if (lo(i) || lo(o)) return q;
						let l = co(i.value, o.value);
						return l.valid
							? ((so(i) || so(o)) && t.dirty(),
		...
		Na.create = (e, t, n) =>
			new Na({ left: e, right: t, typeName: $.ZodIntersection, ...K(n) });
		...
		var Nr = class extends te {
				...
				_parse(e) {
					...
					return n.common.async
						? We.mergeObjectAsync(t, r)
						: We.mergeObjectSync(t, r);
				}
				get element() {
					return this._def.valueType;
				}
		...
		Fr.create = (e, t, n) =>
			new Fr({ valueType: t, keyType: e, typeName: $.ZodMap, ...K(n) });
		...
		var fa = class extends te {
				...
				args(...e) {
					return new fa({
						...this._def,
						args: Rt.create(e).rest(on.create()),
					});
				}
				returns(e) {
				...
				static create(e, t, n) {
					return new fa({
						args: e || Rt.create([]).rest(on.create()),
						returns: t || on.create(),
		...
		Fa.create = (e, t) =>
			new Fa({ getter: e, typeName: $.ZodLazy, ...K(t) });
		...
		Aa.create = (e, t) =>
			new Aa({ value: e, typeName: $.ZodLiteral, ...K(t) });
		function l0(e, t) {
		...
		Oa.create = (e, t) =>
			new Oa({ values: e, typeName: $.ZodNativeEnum, ...K(t) });
		...
		Zn.create = (e, t) =>
			new Zn({ type: e, typeName: $.ZodPromise, ...K(t) });
		var pt = class extends te {
			...
			_parse(e) {
				...
				if (
					((i.addIssue = i.addIssue.bind(i)), r.type === 'preprocess')
				) {
		...
		pt.create = (e, t, n) =>
			new pt({ schema: e, typeName: $.ZodEffects, effect: t, ...K(n) });
		...
		Zt.create = (e, t) =>
			new Zt({ innerType: e, typeName: $.ZodOptional, ...K(t) });
		...
		un.create = (e, t) =>
			new un({ innerType: e, typeName: $.ZodNullable, ...K(t) });
		var La = class extends te {
			_parse(e) {
				let { ctx: t } = this._processInputParams(e),
					n = t.data;
				return (
					t.parsedType === L.undefined &&
		...
		Lr.create = (e, t) =>
			new Lr({ innerType: e, typeName: $.ZodReadonly, ...K(t) });
		var c0 = (e, t = {}, n) =>
				e
		...
		var Ym = (e, t = { message: `Input not instance of ${e.name}` }) =>
				c0((n) => n instanceof e, t),
			d0 = Ct.create,
			u0 = sn.create,
			Qm = Or.create,
			Km = cn.create,
			...
			L4 = Tt.union([
				...
				Tt.object({
					message: Tt.literal('grant'),
					denied: Tt.boolean(),
				}),
				Tt.object({
					message: Tt.literal('createdProject'),
					projectId: Tt.string(),
				}),
			]),
			p0 = (e) => {
...
`),
						...
						async (y) => {
							if (
								...
								try {
									...
									if (!h?.viewer)
										throw new Error(
											'Failed to fetch initial project list',
										);
									if (h.viewer.projectCount > 0 || t)
										...
										if (!h.viewer.accounts[0].newProjectUrl)
											throw new Error(
												'Unexpected missing project URL',
											);
										u.current?.(
											h.viewer.accounts[0].newProjectUrl,
										);
									}
								} catch (k) {
									l('Login Error', k);
							...
							y.message === 'createdProject' &&
								(d.current
									? (n(d.current),
									  r(`Project:${y.projectId}`),
									  m.current?.())
									: l(
											'Unexpected missing access token',
											new Error(),
									  ));
						},
						[c, i, o, t, n, l, r],
			...
			h0 = w.div(
				({ theme: e }) => ({
					...
					borderRadius: e.appBorderRadius,
					background:
						e.base === 'light' ? e.color.lightest : e.color.darkest,
					border: `1px solid ${e.appBorderColor}`,
					padding: 15,
					flex: 1,
					gap: 14,
...
`),
			D4 = ({ projectId: e, configFile: t, goToNext: n }) => {
				tt('LinkProject', 'LinkedProject');
				let [{ data: r, fetching: i, error: o }] = Ao({
					query: H4,
...
`)),
		...
		var U4 = w.div(({ theme: e }) => ({
				'&& > *': { margin: 0 },
				'&& pre': {
					color:
						e.base === 'light' ? e.color.darker : e.color.lighter,
					background:
						e.base === 'light' ? e.color.lightest : e.color.darkest,
					fontSize: '12px',
					lineHeight: '16px',
			...
			$4 = 'https://www.chromatic.com/docs/visual-tests-addon/#configure';
		function W4({ projectId: e, configFile: t }) {
			return (
...
`),
			...
			Jl = w.div(({ theme: e }) => ({
				background:
					e.base === 'light' ? e.color.lighter : e.color.darker,
			})),
			Xl = w.div(({ theme: e }) => ({
				background:
					e.base === 'light' ? e.color.lightest : e.color.darkest,
			...
			Y4 = w(de)({ width: '100%' }),
			Q4 = w(g2)({ marginRight: 10 });
		function K4({
			createdProjectId: e,
			setCreatedProjectId: t,
			onSelectProjectId: n,
		}) {
			let [{ data: r, fetching: i, error: o }, l] = Ao({ query: G4 });
			oe(() => {
		...
		var J4 = () =>
			...
			f0 = { isRunning: !1, startBuild: () => {}, stopBuild: () => {} },
			g0 = Je(f0),
			Za = () => Ot(g0, 'RunBuild'),
			tp = ({ children: e, watchState: t = f0 }) =>
				a.createElement(g0.Provider, { value: t }, e),
			v0 = {
				PENDING: 'warn',
				FAILED: 'error',
				DENIED: 'error',
		...
		var e1 = {
			...
			y0 = ({
				...
				let { heading: r, message: i, action: o } = e1[n] || e1.OTHER;
				return a.createElement(
					Me,
					{ footer: null },
					a.createElement(
		...
		var op = b0('function'),
			...
			n1 = (e) => !sp(e) && !lp(e) && (op(e) || typeof e == 'object'),
			sp = b0('undefined');
		function cp(e, t) {
			let { length: n } = e;
		...
		function Ue(e, t) {
			...
			if (e && n1(e) && t && n1(t)) {
				...
				if (Array.isArray(e) && Array.isArray(t)) return cp(e, t);
				if (e instanceof Map && t instanceof Map) return up(e, t);
				if (e instanceof Set && t instanceof Set) return mp(e, t);
				...
				for (let i = n.length; i-- !== 0; ) {
					let o = n[i];
					if (!(o === '_owner' && e.$$typeof) && !Ue(e[o], t[o]))
						return !1;
				}
				return !0;
			}
		...
		T.iterable = (e) =>
			!T.nullOrUndefined(e) && T.function(e[Symbol.iterator]);
		T.map = vt('Map');
		...
		T.primitive = (e) => T.null(e) || gp(typeof e);
		...
		function yp(...e) {
			return e.every(
				(t) => I.string(t) || I.array(t) || I.plainObject(t),
			);
		}
		function bp(e, t, n) {
			return E0(e, t)
				? [e, t].every(I.array)
					? !e.some(l1(n)) && t.some(l1(n))
					: [e, t].every(I.plainObject)
					? !Object.entries(e).some(o1(n)) &&
					  Object.entries(t).some(o1(n))
					: t === n
				: !1;
		}
		function a1(e, t, n) {
		...
		function r1(e, t, n) {
			...
			if (!I.nullOrUndefined(o)) {
				if (I.defined(c)) {
					if (I.array(c) || I.plainObject(c)) return bp(c, d, o);
				} else return Ue(d, o);
				return !1;
			}
		...
		function o1(e) {
			return ([t, n]) =>
				I.array(e)
					? Ue(e, n) ||
					  e.some((r) => Ue(r, n) || (I.array(n) && Vo(n)(r)))
					: I.plainObject(e) && e[t]
					? !!e[t] && Ue(e[t], n)
					: Ue(e, n);
		}
		...
		function l1(e) {
			return (t) =>
				I.array(e)
					? e.some((n) => Ue(n, t) || (I.array(t) && Vo(t)(n)))
					: Ue(e, t);
		}
		function ta(e, t) {
		...
		function Tr(e, t) {
			...
			return {
				added: (n, r) => {
					try {
						return r1(e, t, { key: n, type: 'added', value: r });
					} catch {
						return !1;
					}
				},
				changed: (n, r, i) => {
					try {
						...
						return [o, l].every(I.array) ||
							[o, l].every(I.plainObject)
							? !Ue(o, l)
							: o !== l;
					} catch {
						return !1;
				...
				removed: (n, r) => {
					try {
						return r1(e, t, { key: n, type: 'removed', value: r });
					} catch {
						return !1;
					}
				},
		...
		function Ra(e) {
			...
			var t = hn(e),
				...
				r = t.overflowX,
				i = t.overflowY;
			return /(auto|scroll|overlay)/.test(n + i + r) ? e : Ra(jo(e));
		}
		function C0(e) {
			return e && e.referenceNode ? e.referenceNode : e;
		}
		var s1 = Ia && !!(window.MSInputMethodContext && document.documentMode),
			c1 = Ia && /MSIE 10/.test(navigator.userAgent);
		function jn(e) {
			return e === 11 ? s1 : e === 10 ? c1 : s1 || c1;
		}
		function In(e) {
			if (!e) return document.documentElement;
			for (
				var t = jn(10) ? document.body : null,
		...
		function Ap(e) {
			...
			return t === 'BODY'
				? !1
				: t === 'HTML' || In(e.firstElementChild) === e;
		}
		function uo(e) {
			return e.parentNode !== null ? uo(e.parentNode) : e;
		}
		function _r(e, t) {
			...
			if ((e !== l && t !== l) || r.contains(i)) return Ap(l) ? l : In(l);
			var s = uo(e);
			return s.host ? _r(s.host, t) : _r(e, uo(t).host);
		}
		function Rn(e) {
			var t =
		...
		function S0(e) {
			...
			return {
				height: u1('Height', t, n, r),
				width: u1('Width', t, n, r),
			};
		}
		var Lp = function (e, t) {
				if (!(e instanceof t))
		...
		function mo(e) {
			...
			var i = {
				...
				o = e.nodeName === 'HTML' ? S0(e.ownerDocument) : {},
		...
		function M0(e) {
			...
			for (var t = e.parentElement; t && hn(t, 'transform') === 'none'; )
				t = t.parentElement;
		...
		function Do(e, t, n, r) {
			...
			if (r === 'viewport') o = _p(l, i);
				...
				r === 'scrollParent'
					...
					: (s = r);
				var c = Ho(s, l, i);
				if (s.nodeName === 'HTML' && !x0(l)) {
					var d = S0(e.ownerDocument),
						u = d.height,
						m = d.width;
		...
		function N0(e, t, n, r, i) {
			...
			var l = Do(n, r, o, i),
				...
				c = Object.keys(s)
					.map(function (p) {
						return it({ key: p }, s[p], { area: Zp(s[p]) });
					})
					.sort(function (p, g) {
		...
		function L0(e, t, n) {
			var r = n === void 0 ? e : e.slice(0, Ip(e, 'name', n));
			return (
				r.forEach(function (i) {
					...
					i.enabled &&
						w0(o) &&
						((t.offsets.popper = qt(t.offsets.popper)),
						(t.offsets.reference = qt(t.offsets.reference)),
						(t = o(t, i)));
				}),
				t
			);
		...
		function Bp() {
			return (
				...
				T0(this.modifiers, 'applyStyle') &&
					...
					(this.popper.style[zo('transform')] = '')),
		...
		function Z0(e, t, n, r) {
			...
			o.addEventListener(t, n, { passive: !0 }),
				i || Z0(Ra(o.parentNode), t, n, r),
				r.push(o);
		}
		function Pp(e, t, n, r) {
			(n.updateBound = r),
				_0(e).addEventListener('resize', n.updateBound, {
					passive: !0,
				});
			var i = Ra(e);
			return (
				Z0(i, 'scroll', n.updateBound, n.scrollParents),
				(n.scrollElement = i),
				(n.eventsEnabled = !0),
				n
			);
		...
		function jp(e, t) {
			return (
				_0(e).removeEventListener('resize', t.updateBound),
		...
		function Hp() {
			this.state.eventsEnabled &&
				...
				(this.state = jp(this.reference, this.state)));
		}
		function Uo(e) {
		...
		function zp(e) {
			return (
				po(e.instance.popper, e.styles),
				Dp(e.instance.popper, e.attributes),
				e.arrowElement &&
					Object.keys(e.arrowStyles).length &&
					po(e.arrowElement, e.arrowStyles),
				e
			);
		}
		function Up(e, t, n, r, i) {
			var o = F0(i, t, e, n.positionFixed),
				l = N0(
					n.placement,
					o,
					t,
			...
			return (
				...
				po(t, { position: n.positionFixed ? 'fixed' : 'absolute' }),
				n
			);
		}
		function $p(e, t) {
		...
		var Wp = Ia && /Firefox/i.test(navigator.userAgent);
		function Gp(e, t) {
			var n = t.x,
				r = t.y,
				i = e.offsets.popper,
			...
			var l = o !== void 0 ? o : t.gpuAcceleration,
				...
				u = $p(e, window.devicePixelRatio < 2 || !Wp),
		...
		function qp(e, t) {
			var n;
			if (!I0(e.instance.modifiers, 'arrow', 'keepTogether')) return e;
			var r = t.element;
			if (typeof r == 'string') {
			...
			return (
				...
				(e.arrowElement = r),
				(e.offsets.arrow =
					((n = {}), Bn(n, m, Math.round(v)), Bn(n, p, ''), n)),
				e
			);
		}
		function Yp(e) {
			...
			return (
				l.forEach(function (s, c) {
					...
					(p || b || S) &&
						...
						(e = L0(e.instance.modifiers, e, 'flip')));
				}),
				e
			);
		}
		...
		function a3(e) {
			if (!I0(e.instance.modifiers, 'hide', 'preventOverflow')) return e;
		...
		var i3 = {
				shift: { order: 100, enabled: !0, fn: n3 },
				offset: { order: 200, enabled: !0, fn: e3, offset: 0 },
				preventOverflow: {
					order: 300,
					enabled: !0,
					fn: t3,
				...
				keepTogether: { order: 400, enabled: !0, fn: Kp },
				arrow: {
					order: 500,
					enabled: !0,
					fn: qp,
				...
				inner: { order: 700, enabled: !1, fn: r3 },
				hide: { order: 800, enabled: !0, fn: a3 },
				computeStyle: {
					order: 850,
					enabled: !0,
					fn: Gp,
			...
			Jr = (function () {
				function e(t, n) {
					...
					Lp(this, e),
						...
						(this.update = Fp(this.update.bind(this))),
						...
						Object.keys(
							it({}, e.Defaults.modifiers, i.modifiers),
						).forEach(function (l) {
		...
		var m3 = B0('function'),
			...
			f1 = function (e) {
				return !h3(e) && !p3(e) && (m3(e) || typeof e == 'object');
			},
			h3 = B0('undefined'),
			fo = function (e) {
		...
		function Ye(e, t) {
			...
			if (e && f1(e) && t && f1(t)) {
				if (e.constructor !== t.constructor) return !1;
				if (Array.isArray(e) && Array.isArray(t)) return f3(e, t);
				if (e instanceof Map && t instanceof Map) return v3(e, t);
				if (e instanceof Set && t instanceof Set) return y3(e, t);
				if (ArrayBuffer.isView(e) && ArrayBuffer.isView(t))
					return g3(e, t);
				if (h1(e) && h1(t))
					return e.source === t.source && e.flags === t.flags;
				...
				for (var i = n.length; i-- !== 0; ) {
					var o = n[i];
					if (!(o === '_owner' && e.$$typeof) && !Ye(e[o], t[o]))
						return !1;
				}
				return !0;
			}
		...
		function E3(e, t, n) {
			return P0(e, t)
				? [e, t].every(V.array)
					? !e.some(E1(n)) && t.some(E1(n))
					: [e, t].every(V.plainObject)
					? !Object.entries(e).some(b1(n)) &&
					  Object.entries(t).some(b1(n))
					: t === n
				: !1;
		}
		function g1(e, t, n) {
			var r = n.actual,
				...
				d =
					...
					(l === 'increased' ? s < c : s > c);
			return (
				V.undefined(r) || (d = d && c === r),
				V.undefined(o) || (d = d && s === o),
				d
			);
		}
		function v1(e, t, n) {
			...
			if (!V.nullOrUndefined(o)) {
				if (V.defined(c)) {
					if (V.array(c) || V.plainObject(c)) return E3(c, d, o);
				} else return Ye(d, o);
				return !1;
			}
			return [l, s].every(V.array)
				...
				? k3(Object.keys(c), Object.keys(d))
				: ![l, s].every(function (u) {
						return V.primitive(u) && V.defined(u);
				  }) &&
				  (i === 'added'
						? !V.defined(l) && V.defined(s)
						: V.defined(l) && !V.defined(s));
		}
		function y1(e, t, n) {
			var r = n === void 0 ? {} : n,
				...
				o = xt(e, i),
				l = xt(t, i);
			if (!P0(o, l)) throw new TypeError('Inputs have different types');
			if (!b3(o, l)) throw new TypeError("Inputs don't have length");
			return (
				[o, l].every(V.plainObject) &&
		...
		function w3(e, t) {
			...
			var n = function (m, p) {
					try {
						return v1(e, t, { key: m, type: 'added', value: p });
					} catch {
						return !1;
					}
				},
				r = function (m, p, g) {
					try {
						...
						return [f, y].every(V.array) ||
							[f, y].every(V.plainObject)
							? !Ye(f, y)
							: f !== y;
					} catch {
						return !1;
				...
				u = function (m, p) {
					try {
						return v1(e, t, { key: m, type: 'removed', value: p });
					} catch {
						return !1;
					}
				};
		...
		function xe(e) {
			for (var t = 1; t < arguments.length; t++) {
				...
				t % 2
					? k1(Object(n), !0).forEach(function (r) {
							He(e, r, n[r]);
					  })
					: Object.getOwnPropertyDescriptors
					? Object.defineProperties(
					...
					: k1(Object(n)).forEach(function (r) {
							Object.defineProperty(
								e,
								r,
		...
		var N3 = { flip: { padding: 20 }, preventOverflow: { padding: 10 } },
			F3 =
		...
		function _3(e, t) {
			...
			if (t && typeof t != 'string') throw new TypeError(A3);
		}
		function C1(e, t, n) {
			return (
				_3(e, n),
					...
					},
					{
						...
						value: function () {
							...
							var r = this.props,
								i = r.children,
								o = r.setRef;
							if ((this.node || this.appendNode(), aa))
								return Qn.createPortal(i, this.node);
							...
							return (
								s ||
									(l.startsWith('top')
										...
										: l.startsWith('right') &&
										  (b.padding = '0 0 0 '.concat(
												u,
												'px',
										  ))),
								[le.OPENING, le.OPEN].indexOf(c) !== -1 &&
									(b = xe(xe({}, b), f)),
								c === le.CLOSING && (b = xe(xe({}, b), g)),
								c === le.OPEN && !i && (b = xe(xe({}, b), y)),
								l === 'center' && (b = xe(xe({}, b), p)),
								o && (b = xe(xe({}, b), k)),
								xe(xe({}, m), b)
							);
						},
					},
					{
						...
						value: function () {
							...
							return (
								i
									? a.isValidElement(i)
										? (d.content = a.cloneElement(i, {
												closeFn: o,
										  }))
										: (d.content = i({ closeFn: o }))
									: (d.content = a.createElement(
											U0,
											this.props,
									  )),
								c === le.OPEN && u.push('__floater__open'),
								l ||
									(d.arrow = a.createElement(D0, this.props)),
								a.createElement(
									'div',
									{
										ref: s,
		...
		var P3 = { zIndex: 100 };
		function V3(e) {
			var t = (0, ho.default)(P3, e.options || {});
			return {
				wrapper: {
					cursor: 'help',
					display: 'inline-flex',
					...
					Va(n, [
						...
						},
						{
							...
							value: function () {
								...
								if (o) {
									var v = V.undefined(p.offset)
										? 0
										: p.offset;
									new p1(this.target, this.wrapperRef, {
		...
		var D3 = ht(vd(), 1),
			...
			U3 = (e, t, n) =>
				t in e
					...
					: (e[t] = n),
			R = (e, t, n) => (U3(e, typeof t != 'symbol' ? t + '' : t, n), n),
			me = {
				INIT: 'init',
				START: 'start',
				STOP: 'stop',
		...
		function ei(e, t, n) {
			if (!e) return an();
			let r = (0, k0.default)(e);
			if (r) {
				if (r.isSameNode(an())) return n ? document : an();
				if (!(r.scrollHeight > r.offsetHeight) && !t)
					return (r.style.overflow = 'initial'), an();
			}
			return r;
		}
		function ti(e, t) {
		...
		function Y3(e, t, n) {
			...
			return (
				o instanceof HTMLElement &&
					((s = o.scrollTop),
					!l && !Ta(e) && (c += s),
					o.isSameNode(an()) || (c += an().scrollTop)),
				Math.floor(c - t)
			);
		}
		function Q3(e, t, n) {
		...
		function K3(e, t) {
			...
			return new Promise((i, o) => {
				let { scrollTop: l } = r,
					s = e > l ? e - l : l - e;
				kp.default.top(r, e, { duration: s < 100 ? 50 : n }, (c) =>
					c &&
		...
		var ra = Kn !== void 0;
		function q0(e = navigator.userAgent) {
			let t = e;
			return (
				typeof window > 'u'
					? (t = 'node')
		...
		function M1() {
			return !['chrome', 'safari', 'firefox', 'opera'].includes(q0());
		}
		...
		var th = {
			...
			N1 = { borderRadius: 4, position: 'absolute' };
		function ih(e, t) {
			let n = (0, Oi.default)(e ?? {}, t ?? {}),
				r = (0, Oi.default)(rh, n.options || {}),
				{ width: i } = r;
			...
			let o = {
				...
				l = {
					...
					beaconOuter: {
						...
						backgroundColor: `rgba(${X3(r.primaryColor).join(
							',',
						)}, 0.2)`,
					...
					spotlight: { ...N1, backgroundColor: 'gray' },
					spotlightLegacy: {
						...N1,
		...
		function oa(e, t) {
			var n, r, i, o, l, s;
			let c = e ?? {},
				d = er.default.all([nh, oh(t), c], {
					isMergeableObject: I.plainObject,
				}),
				u = ih(t.styles, d.styles),
			...
			return (
				(p.offset = d.offset),
				(p.styles = (0, er.default)(
					(i = p.styles) != null ? i : {},
					u.floaterStyles,
				)),
				(p.offset +=
					(l =
						(o = t.spotlightPadding) != null
							? o
							: d.spotlightPadding) != null
						? l
						: 0),
				d.placementBeacon &&
					p.wrapperOptions &&
				...
				{
					...d,
					locale: er.default.all([
						Y0,
						(s = t.locale) != null ? s : {},
						d.locale || {},
					]),
					floaterProps: p,
					styles: wp(u, 'floaterStyles'),
				}
			);
		}
		function Q0(e, t = !1) {
		...
		var lh = {
			...
			A1 = ['action', 'index', 'lifecycle', 'status'],
			sh = class {
				constructor(e) {
					R(this, 'beaconPopper'),
						...
						R(this, 'update', (i) => {
							...
							if (!J3(i, A1))
								throw new Error(
									`State is not valid. Valid keys: ${A1.join(
										', ',
									)}`,
								);
							this.setState({
      ...
      `),
				...
				render() {
					let {
						...
						d = I.string(i.open) ? i.open : (0, D3.default)(i.open),
						u = {
							'aria-label': d,
							onClick: o,
							onMouseEnter: o,
		...
		var ph = mh,
			hh = class extends Vt {
					...
					super(...arguments),
						...
						R(this, 'handleMouseMove', (e) => {
							let { mouseOverSpotlight: t } = this.state,
								...
								u = c >= r && c <= r + l && d;
							u !== t &&
								this.updateState({ mouseOverSpotlight: u });
						}),
						R(this, 'handleScroll', () => {
				...
				render() {
					let { mouseOverSpotlight: e, showSpotlight: t } =
							this.state,
						{
							disableOverlay: n,
					...
					let d = {
						...
						u =
							l !== 'center' &&
							t &&
							x(ph, { styles: this.spotlightStyles });
					if (q0() === 'safari') {
				...
				x(
					...
					x(
						...
						v &&
							x(
								'h1',
								{ 'aria-label': Ut(v), style: h.tooltipTitle },
								v,
							),
		...
		var bh = yh,
					...
					if (
						...
						B && q3(S)
							...
							: (console.warn(
							  ...
							  o ||
									p.update({
										index: s + (n === me.PREV ? -1 : 1),
									}));
					}
					f('lifecycle', X.INIT, X.READY) &&
						p.update({
							lifecycle: x1(m) || k ? X.TOOLTIP : X.BEACON,
						}),
						g('index') &&
							mn({
								title: `step:${c}`,
						...
						g('lifecycle', X.BEACON) &&
							r({ ...y, step: m, type: ut.BEACON }),
						g('lifecycle', X.TOOLTIP) &&
							(r({ ...y, step: m, type: ut.TOOLTIP }),
							this.tooltip &&
								((this.scope = new dh(this.tooltip, {
			...
			K0 = class extends Vt {
				constructor(e) {
					...
					(this.store = ch({ ...e, controlled: r && I.number(i) })),
				...
				componentDidUpdate(e, t) {
					...
					if (
						(B &&
							(F1(u, s)
								? f(u)
								: console.warn('Steps are not valid', u)),
						h('run') && (c ? y(d) : k()),
						j)
					) {
					...
					!r &&
						...
						this.callback({
							...this.state,
							type: ut.TARGET_NOT_FOUND,
							step: S,
						}));
					let J = { ...this.state, index: i, step: S };
					if (
						v('action', [me.NEXT, me.PREV, me.SKIP, me.CLOSE]) &&
						v('status', ne.PAUSED)
					) {
				...
				scrollToStep(e) {
					...
					if (r === ne.RUNNING && p) {
						...
						(y = y >= 0 ? y : 0),
							r === ne.RUNNING &&
								K3(y, { element: f, duration: l }).then(() => {
									setTimeout(() => {
										var h;
										(h = this.store.getPopper('tooltip')) ==
											null || h.instance.update();
									}, 10);
								});
					}
				}
		...
		function Go(e) {
			let {
					...
					(m, p) => (
						(m.statusCounts[p.status] =
							(m.statusCounts[p.status] || 0) + 1),
						p.status === 'IN_PROGRESS' && (m.isInProgress = !0),
						p.result &&
							['CHANGED', 'ADDED'].includes(p.result) &&
							(m.changeCount += 1),
						p.result &&
							['CAPTURE_ERROR', 'SYSTEM_ERROR'].includes(
								p.result,
							) &&
							(m.brokenCount += 1),
						p.comparisons?.forEach(({ browser: g, result: f }) => {
							m.resultsByBrowser[g.id] = Rr([
								f ?? void 0,
								m.resultsByBrowser[g.id],
							]);
						}),
						p.comparisons?.forEach(({ result: g }) => {
							m.resultsByMode[p.mode.name] = Rr([
								g ?? void 0,
				...
				c = e.length
					? Object.fromEntries(
							e[0].comparisons.map((m) => [
								m.browser.id,
								m.browser,
							]),
					  )
					: {},
				d = Object.entries(o).map(([m, p]) => ({
					browser: c[m],
					result: p,
				})),
				u = Object.entries(l).map(([m, p]) => ({
					mode: s[m],
					result: p,
				}));
			return {
		...
		var Sh = (e) => {
			...
			J0 = ({ result: e }) => e !== 'EQUAL' && e !== 'FIXED',
			xh = (e, t) => {
				let n = e.filter((i) => i.comparisons.some(J0)),
					r = n.length ? n : e;
...
`),
			Zh = ({
				...
				let [{ data: i, error: o, operation: l }, s] = Ao({
					query: Fh,
					variables: {
						projectId: e,
						storyId: t,
						testStatuses: Object.keys(v0),
						branch: n.branch || '',
						...(n.slug
							? { repositoryOwnerName: n.slug.split('/', 1)[0] }
							: {}),
				...
				let c = l && t && l.variables.storyId !== t,
					d = Nn(Ah, i?.project?.lastBuildOnBranch),
					u = [
						...Nn(
							Lh,
					...
					f = Nn(
						Oh,
						i?.selectedBuild ??
							(g ? i?.project?.lastBuildOnBranch : void 0),
					);
				return {
					...
					queryError: o,
					userCanReview:
						!!i?.viewer?.projectMembership?.userCanReview,
				...
				return (
					...
					a.createElement(
						qo.Provider,
						{
							value: jt(
								() => t,
								[JSON.stringify(t?.selectedBuild)],
							),
						},
						a.createElement(
							ec.Provider,
			...
			Rh = w.div(({ width: e, height: t, left: n, top: r }) => ({
				width: `${e}px`,
				height: `${t}px`,
				left: `${n}px`,
				top: `${r}px`,
		...
		function Vh(e) {
			let t = this;
			switch (((t.shape = t.shape || Ph(1, 6)), t.shape)) {
				case 2: {
					let n = t.w / 2,
						r = t.h / 2;
					e.moveTo(-n + 2, -r),
		...
		var jh = w.div(({ theme: e }) => ({
			...
			$h = ({
				...
				a.createElement(
					...
					a.createElement(
						Hh,
						null,
						t.title && a.createElement(Dh, null, t.title),
						a.createElement(zh, null, t.content),
					),
			...
			Wh = ({
				...
				d.current !== c &&
					...
					oe(() => {
						e.getCurrentStoryData()?.type !== 'story' &&
							e.jumpToStory(1),
							e.togglePanel(!0),
							e.togglePanelPosition('right'),
							e.setSelectedPanel(ln);
					}, [e]);
				...
				return (
					oe(() => {
						let y = document.getElementById(
							...
							k = Array.from(
								y instanceof HTMLElement ? y.children : [],
							)
					...
					oe(() => {
						o?.selectedTest?.status === 'ACCEPTED' &&
							p === 5 &&
							(m(!0), g(6));
						...
						a.createElement(wh, {
							...
							styles: {
								...
								spotlight: {
									...
									boxShadow:
										'0px 0px 0px 9999px rgba(0,0,0,0.4)',
								},
								options: {
									zIndex: 1e4,
			...
			Gh = ({ content: e }) => {
				...
				return a.createElement(
					...
					t.reduce(
						(n, r, i) =>
							n.concat(
								[i && a.createElement('br', null), r].filter(
									Boolean,
								),
							),
						[],
			...
			nc = ({ localBuildProgress: e, title: t }) =>
				a.createElement(
					h0,
					{ warning: !0 },
					a.createElement(
				...
				a.createElement(
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement(nc, { localBuildProgress: t }),
							e,
						),
					),
				)
		...
		var Qh =
			...
			n7 = w(G)(({ theme: e }) => ({ color: e.color.darkest })),
			a7 = ({ onSkip: e, runningSecondBuild: t }) =>
				a.createElement(
					Me,
					{ footer: null },
					a.createElement(
			...
			o7 = ({ isUnchanged: e, localBuildProgress: t, ...n }) => (
				...
				n.isRunning && t
					? a.createElement(i7, { localBuildProgress: t })
					: e
					? a.createElement(a7, { ...n })
					: a.createElement(r7, { ...n })
			),
			l7 = w.div(({ status: e, theme: t }) => ({
				position: 'relative',
				display: 'inline-flex',
				border: `1px solid ${
			...
			vo = ({ backgroundColor: e, status: t, thumbnailUrl: n }) =>
				a.createElement(
					l7,
					{ status: t },
					a.createElement(
					...
					t === 'positive' && a.createElement(Eo, null),
				),
			L1 = w(G)({ marginBottom: 5 }),
						...
						n
							? a.createElement(
									...
									a.createElement(
										...
										r.selectedComparison?.headCapture
											?.captureImage &&
											a.createElement(vo, {
												...r.selectedComparison
													?.headCapture?.captureImage,
												status: 'positive',
											}),
									),
									a.createElement(
			...
			d7 = w(G)({ marginBottom: 5 }),
			u7 = ({ onCatchAChange: e, onSkip: t }) => {
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement(
								...
								n?.selectedComparison?.headCapture
									?.captureImage &&
									a.createElement(vo, {
										...n?.selectedComparison?.headCapture
											.captureImage,
			...
			m7 = ({
				...
				return t?.currentStep === 'error'
					...
					? i
						? a.createElement(T1, { onComplete: o, onSkip: l })
						: a.createElement(u7, { onCatchAChange: y, onSkip: l })
					: m && !i
					? a.createElement(o7, {
							isRunning: s,
			...
			f7 = w(os)({ animation: `${h7} 1s linear infinite` }),
			...
			I1 = w.div(({ isWarning: e, percentage: t, theme: n }) => {
			...
			b7 = ({ localBuildProgress: e, expanded: t = !1 }) => {
				let n = Pe({});
				oe(() => {
				...
				let r = ['aborted', 'error'].includes(e.currentStep),
					i = Ji.map((o) => {
						...
						return d
							? {
									...m,
									icon: a.createElement(Wt, { style: nr }),
									renderLabel: m.renderProgress,
							  }
							: c
							? {
									...m,
									icon: a.createElement(f7, { style: nr }),
									renderLabel: m.renderProgress,
							  }
							: u
							? {
									...m,
									icon: a.createElement(Td, { style: nr }),
									renderLabel: m.renderName,
							  }
							: {
									...m,
									icon: a.createElement(Eo, { style: nr }),
			...
			E7 = ({
				...
				return a.createElement(
					Z1,
					{ onClick: i },
					a.createElement(I1, { percentage: 100 }),
					c(),
				);
			},
			k7 = ({ onClose: e }) =>
			...
			rc = Je(ac),
			ic = () => Ot(rc, 'ReviewTest'),
			w7 = ({ children: e, watchState: t = ac }) =>
				a.createElement(rc.Provider, { value: t }, e),
			C7 = w.div(
				({ theme: e }) => ({
					position: 'relative',
					display: 'flex',
					...
					o &&
						a.createElement(
							R1,
							{
								isVisible: l,
								style: {
									aspectRatio: `${o.imageWidth} / ${o.imageHeight}`,
									width: o.imageWidth,
								},
							},
							(!S || !Ae) && a.createElement(ro, null),
							a.createElement(rr, {
					...
					a.createElement(
						...
						a.createElement(
							'radialGradient',
							{
								...
								gradientUnits: 'userSpaceOnUse',
								gradientTransform:
									'translate(8.00216 8.0046) scale(7.06173)',
							},
			...
			B1 = {
				CHROME: a.createElement(N7, { alt: 'Chrome' }),
				FIREFOX: a.createElement(A7, { alt: 'Firefox' }),
				SAFARI: a.createElement(O7, { alt: 'Safari' }),
				EDGE: a.createElement(F7, { alt: 'Edge' }),
			},
			L7 = w.div(({ theme: e }) => ({
				alignItems: 'center',
				color: e.base === 'light' ? e.color.dark : e.color.light,
			...
			T7 = ({
				...
				!e &&
					i !== 'EQUAL' &&
					n.length >= 2 &&
					(o = a.createElement(Er, { status: i }, o));
				let l =
					n.length > 1 &&
				...
				return a.createElement(
					...
					l
						? a.createElement(
								...
								o,
								a.createElement(P1, null, t.name),
								a.createElement(is, { size: 10 }),
						  )
						: a.createElement(
								L7,
								null,
			...
			_7 = w.div(({ theme: e }) => ({
				...
				svg: {
					verticalAlign: 'top',
					path: {
						fill: e.base === 'light' ? e.color.dark : e.color.light,
					},
				},
			})),
			Z7 = w(Ea)(({ theme: e }) => ({
			...
			I7 = ({
				...
				if (!o) return null;
				let l = a.createElement(Od, null);
				!e &&
					o !== 'EQUAL' &&
					n.length >= 2 &&
					(l = a.createElement(Er, { status: o }, l));
				let s =
					n.length > 1 &&
					n
						.map(({ mode: c, result: d }) => ({
				...
				return a.createElement(
					...
					s
						? a.createElement(
								...
								l,
								a.createElement(V1, null, i.name),
								a.createElement(is, { size: 10 }),
						  )
						: a.createElement(
								_7,
			...
			R7 = ({ theme: e, status: t, variant: n }) =>
				n === 'outline'
							...
							'&:hover': {
								color:
									e.base === 'light'
										? e.color.darkest
										: e.color.lighter,
								backgroundColor: tn(0.03, e.background.app),
							},
					  }
					: t === 'positive'
					? {
					...
					? {
							...
							'&:hover': {
								color: e.color.warningText,
								backgroundColor: tn(0.05, e.background.warning),
							},
					  }
					: {
							color: e.color.lightest,
							...
							borderColor:
								e.base === 'light'
									? lr(0.2, e.color.secondary)
									: tn(0.1, e.color.secondary),
							'&:hover': {
								color: e.color.lightest,
								backgroundColor: tn(0.05, e.color.secondary),
							},
					  },
			Sn = w(ot)(
				({ square: e }) => ({
			...
			H1 = w.div({ display: 'flex', flexDirection: 'row' }),
			Br = w.div(
				({ theme: e }) => ({
					width: 12,
					height: 12,
			...
			V7 = w.div(({ theme: e, showDivider: t }) => ({
				gridArea: 'actions',
				display: 'flex',
				alignItems: 'center',
				justifyContent: 'flex-end',
			...
			D7 = ({ icon: e }) => {
				let { color: t } = Xt();
				return {
					passed: a.createElement(ji, {
						style: { ...Ri, color: t.positive },
					}),
					changed: a.createElement(Md, {
						style: { ...Ri, color: t.warning },
					}),
					failed: a.createElement(Wt, {
						style: { ...Ri, color: t.negative },
					}),
				}[e];
			};
		function yo(e) {
		...
		var Y7 = {
			...
			J7 = {
				date: Bi({ formats: Y7, defaultWidth: 'full' }),
				time: Bi({ formats: Q7, defaultWidth: 'full' }),
				dateTime: Bi({ formats: K7, defaultWidth: 'full' }),
			},
			X7 = J7,
			e6 = {
		...
		var a6 = {
			...
			d6 = {
				ordinalNumber: c6,
				era: la({ values: a6, defaultWidth: 'wide' }),
				quarter: la({
					values: r6,
					defaultWidth: 'wide',
				...
				month: la({ values: i6, defaultWidth: 'wide' }),
				day: la({ values: o6, defaultWidth: 'wide' }),
				dayPeriod: la({
					values: l6,
					defaultWidth: 'wide',
					formattingValues: s6,
		...
		function T6(e, t, n) {
			...
			var d = lc(L6(n), { addSuffix: !!n?.addSuffix, comparison: c }),
				u,
				m;
			c > 0 ? ((u = xn(t)), (m = xn(e))) : ((u = xn(e)), (m = xn(t)));
			var p = String(
					(o = n?.roundingMethod) !== null && o !== void 0
						? o
						: 'round',
				),
				g;
		...
		function _6(e, t) {
			return ai(1, arguments), T6(e, Date.now(), t);
		}
		var Z6 = {
		...
		function I6(e, t, n = { addSuffix: !1, comparison: 0 }) {
			let r = Z6[e].replace('{{count}}', t);
		...
		var R6 = (e) =>
				_6(e, { addSuffix: !0, locale: { ...oc, formatDistance: I6 } }),
			ca = w.div(({ theme: e }) => ({
				gridArea: 'info',
				display: 'flex',
				justifySelf: 'start',
  ...
  `,
			...
			D6 = ({
				...
				if (t || !k.length)
					return a.createElement(
						q1,
						{ hidden: o },
						a.createElement(Y1, null, a.createElement(G1, null, J)),
						a.createElement(Q1, null, a.createElement(j1, null)),
					);
				let ce = Go(k),
					{ isInProgress: Ce } = ce,
					Ae =
				...
				return a.createElement(
					...
					a.createElement(
						...
						a.createElement(
							...
							null,
							J,
							a.createElement(j7, { isOutdated: e }),
						),
					),
					a.createElement(
						V6,
						...
						!Ce &&
							...
							a.createElement(M7, {
								...
								latestImage:
									S.headCapture?.captureImage ?? void 0,
								baselineImage:
									S.baseCapture?.captureImage ?? void 0,
								baselineImageVisible: s,
			...
			z6 = w(ui)({ padding: '4px 8px', margin: '0 6px' }),
			U6 = ({ onClose: e }) =>
				a.createElement(
					e0,
					null,
					a.createElement(
						...
						a.createElement(
							...
							null,
							'Warnings',
							a.createElement(z6, { status: 'warning' }, '2'),
							a.createElement(
								Bo,
								{ onClick: e },
								a.createElement(Ro, { 'aria-label': 'Close' }),
		...
		var $6 = ({
				...
				let { settingsVisible: l, warningsVisible: s } = Wr(),
					...
					k = tc(),
					b = fn(),
					{ buildIsReviewable: h, userCanReview: v } = ic(),
					E = !!(!h && f && y && i),
				...
				if (b?.tests?.find((Te) => Te.result === 'SKIPPED'))
					return a.createElement(
						Me,
						null,
						Y,
				...
				let { status: Ce } = k,
					Ae = ['ANNOUNCED', 'PUBLISHED', 'PREPARED'].includes(Ce),
					Se = Ce === 'FAILED',
					Qe = Ce === 'PENDING' && (!v || !h);
				return a.createElement(
					Me,
					...
					a.createElement(
						...
						a.createElement(
							ha,
							{ grow: !0, hidden: !l },
							a.createElement(k7, { onClose: () => c(!1) }),
						),
						a.createElement(
							ha,
							{ grow: !0, hidden: !s },
							a.createElement(U6, { onClose: () => d(!1) }),
						),
					),
				);
			},
			...
			G6 = (e) =>
				Object.fromEntries(Object.entries(e).map(([t]) => [t, null])),
			q6 = ({
				buildIsReviewable: e,
				userCanReview: t,
				onReviewSuccess: n,
				...
				let [{ fetching: i }, o] = xs(_h),
					l = W(
						async (d) => {
							try {
								if (!e)
									throw new Error('Build is not reviewable');
								if (!t)
									throw new Error(
										'No permission to review tests',
									);
					...
					s = W(
						(d, u = 'SPEC') =>
							l({ status: 'ACCEPTED', testId: d, batch: u }),
						[l],
					),
					c = W(
						(d, u = 'SPEC') =>
							l({ status: 'PENDING', testId: d, batch: u }),
						[l],
					);
				return {
					isReviewing: i,
...
`),
			Q6 = ({ lastBuildOnBranch: e, vtaOnboarding: t }) => {
				let n = vn(),
				...
				a.useEffect(() => {
					if (
						n?.getUrlState?.().queryParams.vtaOnboarding === 'true'
					) {
						p(!1);
						return;
					}
			...
			K6 = ({
				...
				let Bt = W(
						() => S?.id && j && n({ buildId: S.id, storyId: d }),
						[n, j, S?.id, d],
					),
					{
						showOnboarding: _e,
				...
				return k && !k.uiTests
					? a.createElement(ip, { manageUrl: b })
					: y?.suspensionReason
					? a.createElement(y0, {
			...
			X6 = ({ active: e, api: t }) => {
					...
					return (
						...
						() => {
							window.removeEventListener('online', _e),
								window.removeEventListener('offline', bt);
						}
					);
				}, []);
				let [c] = Ie(Ud),
					...
					[, f] = Ie(Di),
					y = di({}),
					k = W((_e) => t.experimental_updateStatus(z, _e), [t]),
					{
						loading: b,
						projectId: h,
						configFile: v,
					...
					Ae = W((_e) => y(Yd, _e), [y]),
					{
						...
						startBuild: Qe,
						stopBuild: Te,
					} = Fs({ localBuildProgress: p, accessToken: n }),
					Ne = (_e) =>
						a.createElement(
							ru,
							{ key: ln, value: vu },
				...
				if (window.CONFIG_TYPE !== 'DEVELOPMENT')
					return Ne(a.createElement(J4, null));
				if (ce) return Ne(a.createElement(ep, null));
				if (u) return Ne(a.createElement(X4, { offline: u }));
				if (!n)
					return Ne(
						a.createElement(R4, {
							key: ln,
				...
				if (b) return e ? a.createElement(ro, null) : null;
				if (!h)
					return Ne(
						a.createElement(q4, {
							createdProjectId: Y,
				...
				if (d || !c)
					return console.error(d), Ne(a.createElement(P4, null));
				if (S) {
					if (!v)
						throw new Error(
							'Missing config file after configuration failure',
						);
					return Ne(
						a.createElement(W4, { projectId: h, configFile: v }),
					);
				}
				if (B) {
					if (!v)
						throw new Error(
							'Missing config file after configuration success',
						);
					return Ne(
						a.createElement(D4, {
							projectId: h,
		...
		Yn.register(z, (e) => {
			Yn.add(ln, {
				...
				render: ({ active: r }) =>
					a.createElement(X6, { active: !!r, api: e }),
			}),
				Yn.add(Dd, {
					type: Wa.experimental_SIDEBAR_TOP,
					render: () => a.createElement(c2, { api: e }),
				}),
				Yn.add(zd, {
					type: Wa.experimental_SIDEBAR_BOTTOM,
					render: () => a.createElement(c5, { api: e }),
				});
			let t = e.getChannel();
			if (!t) return;
			let n = !1;
			t.on(`${z}/heartbeat`, () => {
				clearTimeout(K1),
					n &&
						((n = !1), e.clearNotification(`${z}/connection-lost`)),
					(K1 = setTimeout(() => {
						(n = !0),
							e.addNotification({
								id: `${z}/connection-lost`,
								content: {
