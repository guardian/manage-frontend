...
} from '@/client/stores/UpgradeProductStore';
import {
	subHeadingCss,
	...
	return (
		<>
			...
			{previewLoadingState === UpgradePreviewLoadingState.Loading && (
				<Spinner
					loadingMessage={'Loading your subscription details...'}
				/>
			)}
			...
			{previewLoadingState !== UpgradePreviewLoadingState.Loading && (
				<>
					<Card>
						...
						<Card.Section>
							<p css={benefitsTextCss}>
								You pay {nextPaymentDetails?.paymentValueShort}{' '}
					...
					<h2 css={subHeadingWithInformationCss}>
						Upgrade to Digital plus
					</h2>
					<p css={subHeadingInformationTextCss}>
						Get more from your subscription and enjoy new benefits
						and complete access with Digital plus.
					</p>
					<Card>
						<Card.Header
							backgroundColor={
