...
function buildStyledCallExpression(identifier, args, path, state, t) {
  ...
  return t.callExpression(
  // $FlowFixMe
  t.callExpression(identifier, [tag, finalOptions].concat(restArgs)), new _astObject2.default((0, _babelUtils.minify)(src), path.node.quasi.expressions, t).toExpressions());
}
