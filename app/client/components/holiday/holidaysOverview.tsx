...
const renderHolidayStopsOverview =
	...
	(holidayStopsResponse: GetHolidayStopsResponse, reload: ReFetch) => {
		...
		const InnerContent = () => (
			<>
				<h1>
					Suspend {holidaysOverviewProps.productType.friendlyName}
				</h1>
						...
						<>
							<div>
								...
								<strong>
									...
									{
										holidaysOverviewProps.productType
											.holidayStops.issueKeyword
									}
									s
								</strong>{' '}
							...
							{holidaysOverviewProps.productType.holidayStops
								...
								<div>
									{
										holidaysOverviewProps.productType
											.holidayStops.additionalHowAdvice
									}
								</div>
							)}
							<div
							...
							>
								...
								<div>
									...
									is the next anniversary of your
									subscription.
									<br />
									The number of{' '}
									{
									...
									s you can suspend per year is reset on this
									date.
								</div>
							</div>
							<HolidayQuestionsModal
			...
			<HolidayStopsResponseContext.Provider
				value={{
					...
					existingHolidayStopToAmend:
						existingHolidayStopToAmend || undefined,
				}}
			>
