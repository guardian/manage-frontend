...
import { DATE_FNS_LONG_OUTPUT_FORMAT, dateAddYears, dateString, parseDate } from "../../../shared/dates";
import {
  isProduct,
...
> {
  ...
  private innerContent = (
    ...
    <>
      ...
      <p>
        ...
        <strong>
          {dateString(holidayStopsResponse.productSpecifics.firstAvailableDate, "cccc d MMMM")}
        </strong>{" "}
        due to{" "}
  ...
  private validateIssuesSelected = (
    ...
    if (numPotentialIssuesThisYear > issuesRemainingThisYear) {
      const dateElement = anniversaryDateToElement(renewalDate);
      return (
        <>
      ...
      const firstDateElement = anniversaryDateToElement(renewalDate);
      return (
        <>
          Exceeded {this.props.productType.holidayStops.issueKeyword} limit of{" "}
          {annualIssueLimit} between {firstDateElement} and{" "}
          {anniversaryDateToElement(dateAddYears(renewalDate, 1))}{" "}
          <HolidayAnniversaryDateExplainerModal
      ...
      return (
        <>
          ...
          >
            ...
            <HolidayAnniversaryDateExplainerModal
              dateElement={anniversaryDateToElement(renewalDate)}
              issueKeyword={this.props.productType.holidayStops.issueKeyword}
            />
          </div>
        </>
