			...
			return (
				<>
					<CaseUpdateAsyncLoader
						...
						render={this.getFeedbackThankYouRenderer(
							this.props.reason,
						)}
					/>
					<div css={{ height: '20px' }} />
		...
		return (
			<div>
				{!this.props.reason.hideContactUs &&
					!this.props.productType.cancellation
				...
				<div css={{ textAlign: 'right' }}>
					...
					>
						You have{' '}
						{this.props.characterLimit - this.state.feedback.length}{' '}
					...
					{(escalationCauses) => (
						<>
							{escalationCauses.length > 0 && (
								<p>
									Once you submit your cancellation request
									our customer service team will try their
									best to contact you as soon as possible to
									confirm the cancellation and refund any
									credit you are owed.
								</p>
							)}
							<p id="save_body">
					...
					flowWrapper(
						...
						>
							<CaseCreationWrapper
								...
								sfCaseProduct={
									props.productType.cancellation.sfCaseProduct
								}
							>
