	...
	},
	{
		...
		saveBody: (
			<>
				...
				to time.
				<br />
				Making a smaller contribution to the Guardian can be an
				inexpensive way of keeping journalism open for everyone to read
				and enjoy. Once you’ve completed your cancellation below, we
				hope you’ll consider a small one&nbsp;off or recurring
	...
	},
	{
		...
		saveBody: (
			<>
				...
				<br />
				<br />
				Once you’ve completed your cancellation below, you can set up a
				new product via our online checkouts.
			</>
		),
		escalationSaveBody: '',
		skipFeedback: true,
	},
	{
		...
		saveBody: (
			<>
				...
				<br />
				<br />
				Your subscription has ensured that our quality journalism
				remains open for everyone to read and enjoy.
				<br />
	...
	},
	{
		...
		saveBody: (
			<>
				...
				<br />
				Your subscription has ensured that our quality journalism
				remains open for everyone to read and enjoy. You can{' '}
				...
				<br />
				<br />
				Alternatively we’d love to know more about what we could do
				better to help provide inspiring and trustworthy news.
			</>
		),
		escalationSaveBody:
