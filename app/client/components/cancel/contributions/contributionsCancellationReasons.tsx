...
export const contributionsCancellationReasons: CancellationReason[] = [
	...
	},
	{
		...
		saveBody: (
			<>
				<p>
					After cancelling your monthly or annual contribution, we
					will show you how to make a single contribution quickly and
					easily.
				</p>
			</>
		),
	...
	},
	{
		...
		saveBody: (
			<>
				<p>
					After cancelling your monthly contribution, we will show you
					how to set up an annual contribution quickly and easily.
				</p>
			</>
		),
		alternateFeedbackIntro,
	...
	},
	{
		...
		saveBody: (
			<>
				<p>
					After cancelling your annual contribution, we will show you
					how to set up an monthly contribution quickly and easily.
				</p>
			</>
		),
		alternateFeedbackIntro,
