...
export const MembershipFAQs = (props: RouteableProps) => (
  <>
    ...
    <PageNavAndContentContainer selectedNavItem={navLinks.membership}>
      <PageContainerSection>
        ...
        <Accordion initialIndex={-1}>
          <div title="What is membership?">
            <div>
              <p>
                ...
                media and tech giants, means we must look for alternative means
                to fund our journalism. Lots of people around the world read,
                watch and listen to the Guardian’s journalism but many do not
                pay for it. Rather than setting up a paywall, we are asking
                those who can afford it to make their contribution to our
          ...
          <div title="Does membership provide an ad-free experience?">
            <div>
              <p>
                ...
                premium tier of the award-winning Guardian news app, which has
                no adverts, allows you to follow your favourite journalists,
                sign up for alerts to key topics, series and sports events, and
                gives you access to our crosswords. You can download the app by
                visiting{" "}
                ...
                premium tier, please ensure you have the latest version of the
                app downloaded. Once in the app you can choose between the UK,
                US, Australia or International edition.
              </p>
              <p>
          ...
          <div title="What happens if I don't want to receive membership emails?">
            <div>
              ...
              click the unsubscribe link at the bottom of the email. We have
              also created a{" "}
              <a
                css={linkCss}
                href={buildSupportHref({
          ...
          <div title="What happens if I want to change my membership tier?">
            <div>
              You can change your membership tier online anytime. Just go to
              your{" "}
              <a
                css={linkCss}
          ...
          <div title="What happens if I want to cancel my membership?">
            <div>
              ...
              term and then renew on an ongoing basis unless you choose to
              cancel.
            </div>
          </div>
          ...
          <div title="What is Guardian Live?">
            <div>
              Guardian Live is a rolling events programme of discussions,
              debates, interviews and festivals that transform our journalism in
              print and online into live experiences. Recent examples include
              cooking lessons from Nigella Lawson and Jeanette Winterson, guided
              tours of the Guardian archives and printing presses, and talks
              from Johnny Marr, Bryan Cranston and Alan Bennett.{" "}
          ...
          <div title="Can I change from the Tickets Benefit to the Book Benefit?">
            <div>
              ...
              the applicable membership year. To do so, contact membership
              support by either emailing{" "}
              <a css={linkCss} href="mailto:membershipsupport@theguardian.com">
                membershipsupport@theguardian.com
              </a>{" "}
          ...
          <div title="What are Guardian Masterclasses?">
            <div>
              ...
              Chris Difford, and a masterclass in becoming a successful
              journalist from some of our award-winning writers. More{" "}
              <a
                css={linkCss}
