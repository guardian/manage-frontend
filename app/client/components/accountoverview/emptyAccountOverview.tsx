    ...
    <>
      ...
      >
        ...
        <p
          ...
          `}
        >
          If you are already supporting The Guardian, it may be linked to a
          different email address. Please check that you are logged in using the
          correct account or contact our customer service team for help.{" "}
          <span
            css={css`
              cursor: pointer;
              color: ${brand[500]};
